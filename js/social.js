var socialNameSpace = (function () {
  const text = {
    EN: "This visualisation tool, created by Eurostat, displays an interactive energy balance table with a great level of detail.",
  ...
  return {
    ...
    email: function () {
      const subject = encodeURIComponent("Energy balances");
      const body = encodeURIComponent(
        `${text[language]} ${window.location.href}`
      );
