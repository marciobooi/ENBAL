...
(function (Y, K) {
  "object" === typeof module && module.exports
    ? ((K["default"] = K), (module.exports = Y.document ? K(Y) : K))
  ...
  K(l, "Core/Globals.js", [], function () {
    ...
    (function (e) {
      ...
      e.hasBidiBug =
        e.isFirefox && 4 > parseInt(e.userAgent.split("Firefox/")[1], 10);
      ...
      e.supportsPassiveEvents = (function () {
        ...
        if (!e.isMS) {
          ...
          e.win.addEventListener &&
            ...
            (e.win.addEventListener("testPassive", e.noop, l),
            e.win.removeEventListener("testPassive", e.noop, l));
        }
        return f;
      })();
      e.charts = [];
  ...
  K(l, "Core/Utilities.js", [l["Core/Globals.js"]], function (f) {
    function e(c, u, g, k) {
      ...
      x(
        f,
        "displayError",
        { chart: g, code: c, message: n, params: k },
        function () {
          if (u) throw Error(n);
    ...
    function l(a, c) {
      var A = {};
      w(a, function (u, g) {
        if (G(a[g], !0) && !a.nodeType && c[g])
          (u = l(a[g], c[g])), Object.keys(u).length && (A[g] = u);
    ...
    function q(a, c) {
      f.isMS &&
        ...
        c &&
        h(c.opacity) &&
        (c.filter = "alpha(opacity=".concat(100 * c.opacity, ")"));
      b(a.style, c);
    }
    function r(a) {
      ...
      if ("width" === u)
        return (
          ...
          Math.max(
            0,
            u -
              (A(c, "padding-left", !0) || 0) -
              (A(c, "padding-right", !0) || 0)
          )
        );
      if ("height" === u)
        return Math.max(
    ...
    function z(a, c, g) {
      ...
      if (Object.hasOwnProperty.call(k, "hcEvents")) {
        ...
        c
          ? ((k = m[c] || []),
            g
              ? ((m[c] = k.filter(function (a) {
                  return g !== a.fn;
                })),
                A(c, g))
              : (u(m), (m[c] = [])))
          : (u(m), delete k.hcEvents);
      }
    }
    function x(a, c, g, m) {
      g = g || {};
      if (k.createEvent && (a.dispatchEvent || (a.fireEvent && a !== f))) {
        ...
        for (var u = a, n = !1; u.hcEvents; )
          Object.hasOwnProperty.call(u, "hcEvents") &&
            u.hcEvents[c] &&
            (A.length && (n = !0), A.unshift.apply(A, u.hcEvents[c])),
      ...
      function (a, c) {
        f[c] = function (A) {
          ...
          e(
            ...
            !1,
            void 0,
            ((u = {}), (u["Highcharts.".concat(c)] = "use Array.".concat(a)), u)
          );
    ...
    a.jQuery &&
      (a.jQuery.fn.highcharts = function () {
        ...
        if (this[0])
          return a[0]
            ? (new f[v(a[0]) ? a.shift() : "Chart"](this[0], a[0], a[1]), this)
    ...
    g = {
      ...
      createElement: function (a, c, g, m, n) {
        a = k.createElement(a);
        c && b(a, c);
        n && q(a, { padding: "0", border: "none", margin: "0" });
        g && q(a, g);
        m && m.appendChild(a);
        return a;
      },
      ...
      normalizeTickInterval: function (a, c, g, k, m) {
        ...
        for (
          ...
          k < c.length &&
          !((u = c[k]),
          (m && u * g >= a) || (!m && A <= (c[k] + (c[k + 1] || c[k])) / 2));
          k++
        );
        return (u = n(u * g, -Math.round(Math.log(0.001) / Math.LN10)));
      },
      objectEach: w,
      offset: function (c) {
  ...
  K(
    l,
    "Core/Color/Color.js",
    [l["Core/Globals.js"], l["Core/Utilities.js"]],
    function (f, e) {
      var l = e.isNumber,
        C = e.merge,
        v = e.pInt;
      e = (function () {
        ...
        e.prototype.init = function (f) {
          var B;
          if ("object" === typeof f && "undefined" !== typeof f.stops)
            ...
            if ("#" === f.charAt(0)) {
              ...
              7 === y
                ? (B = [(t & 16711680) >> 16, (t & 65280) >> 8, t & 255, 1])
                : 4 === y &&
                  (B = [
                    ((t & 3840) >> 4) | ((t & 3840) >> 8),
                    ((t & 240) >> 4) | (t & 240),
        ...
        e.prototype.tweenTo = function (e, B) {
          ...
          return (
            (e ? "rgba(" : "rgb(") +
            Math.round(t[0] + (y[0] - t[0]) * (1 - B)) +
            "," +
            Math.round(t[1] + (y[1] - t[1]) * (1 - B)) +
            "," +
            Math.round(t[2] + (y[2] - t[2]) * (1 - B)) +
            (e ? "," + (t[3] + (y[3] - t[3]) * (1 - B)) : "") +
            ")"
          );
        };
  ...
  K(
    ...
    function (f, e) {
      var l = f.win,
        ...
        q =
          f.isSafari && l.Intl && !l.Intl.DateTimeFormat.prototype.formatRange;
      e = (function () {
        function r(n) {
          this.options = {};
        ...
        r.prototype.set = function (n, b, d) {
          if (this.variableTimezone || this.timezoneOffset) {
            if (
              "Milliseconds" === n ||
              "Seconds" === n ||
              ("Minutes" === n && 0 === this.getTimezoneOffset(b) % 36e5)
            )
              return b["setUTC" + n](d);
          ...
          return this.useUTC || (p && "FullYear" === n)
            ? b["setUTC" + n](d)
            : b["set" + n](d);
        };
        r.prototype.update = function (b) {
          ...
          this.timezoneOffset =
            ((this.useUTC = n) && b.timezoneOffset) || void 0;
          this.getTimezoneOffset = this.timezoneOffsetFunction();
        ...
        r.prototype.makeTime = function (b, d, r, p, x, m) {
          if (this.useUTC) {
            ...
            a !== g
              ? (k += g - a)
              : a - 36e5 !== this.getTimezoneOffset(k - 36e5) ||
                q ||
                (k -= 36e5);
          } else
            k = new this.Date(
        ...
        r.prototype.dateFormat = function (b, d, r) {
          if (!C(d) || isNaN(d))
            return (
              (f.defaultOptions.lang && f.defaultOptions.lang.invalidDate) || ""
            );
          b = h(b, "%Y-%m-%d %H:%M:%S");
          var n = this,
            p = new this.Date(d),
          ...
          y(p, function (a, c) {
            for (; -1 !== b.indexOf("%" + c); )
              b = b.replace(
                "%" + c,
                "function" === typeof a ? a.call(n, d) : a
              );
          });
        ...
        r.prototype.resolveDTLFormat = function (b) {
          return G(b, !0)
            ? b
            : ((b = d(b)), { main: b[0], from: b[1], to: b[2] });
        };
        r.prototype.getTimeTicks = function (d, r, p, q) {
          ...
          if (C(r)) {
            n.set(
              "Milliseconds",
              a,
              g >= b.second ? 0 : c * Math.floor(n.get("Milliseconds", a) / c)
            );
            g >= b.second &&
              n.set(
                "Seconds",
                a,
                g >= b.minute ? 0 : c * Math.floor(n.get("Seconds", a) / c)
              );
            g >= b.minute &&
              n.set(
                "Minutes",
                a,
                g >= b.hour ? 0 : c * Math.floor(n.get("Minutes", a) / c)
              );
            g >= b.hour &&
              n.set(
                "Hours",
                a,
                g >= b.day ? 0 : c * Math.floor(n.get("Hours", a) / c)
              );
            g >= b.day &&
              n.set(
                "Date",
                ...
                g >= b.month
                  ? 1
                  : Math.max(1, c * Math.floor(n.get("Date", a) / c))
              );
            if (g >= b.month) {
              n.set(
                "Month",
                a,
                g >= b.year ? 0 : c * Math.floor(n.get("Month", a) / c)
              );
            ...
            g === b.week &&
              ((A = n.get("Day", a)),
              n.set("Date", a, n.get("Date", a) - A + q + (A < q ? -7 : 0)));
            A = n.get("FullYear", a);
            q = n.get("Month", a);
            var u = n.get("Date", a),
              z = n.get("Hours", a);
            ...
            (!n.variableTimezone && n.useUTC) ||
              ...
              (D =
                p - r > 4 * b.month ||
                n.getTimezoneOffset(r) !== n.getTimezoneOffset(p));
            r = a.getTime();
            for (a = 1; r < p; )
              m.push(r),
                (r =
                  g === b.year
                    ...
                    : !D || (g !== b.day && g !== b.week)
                    ? D && g === b.hour && 1 < c
                      ? n.makeTime(A, q, u, z + a * c)
                      : r + g * c
                    : n.makeTime(A, q, u + a * c * (g === b.day ? 1 : 7))),
                a++;
            m.push(r);
            g <= b.hour &&
              1e4 > m.length &&
          ...
          m.info = E(d, { higherRanks: k, totalRange: g * c });
          return m;
        };
        r.prototype.getDateFormat = function (n, d, r, p) {
          ...
          for (a in b) {
            if (
              n === b.week &&
              +this.dateFormat("%w", d) === r &&
              "00:00:00.000" === q.substr(6)
            ) {
              var a = "week";
              break;
            }
            ...
            if (m[a] && q.substr(m[a]) !== "01-01 00:00:00.000".substr(m[a]))
              break;
            "week" !== a && (k = a);
          }
  ...
  K(
    ...
    [
      l["Core/Chart/ChartDefaults.js"],
      l["Core/Color/Color.js"],
      l["Core/Globals.js"],
      l["Core/Color/Palettes.js"],
      l["Core/Time.js"],
      l["Core/Utilities.js"],
    ],
    function (f, e, l, C, v, E) {
      ...
      f = {
        ...
        setOptions: function (t) {
          ...
          if (t.time || t.global)
            l.time
              ? l.time.update(P(B.global, B.time, t.global, t.time))
              : (l.time = y);
          return B;
        },
      };
  ...
  K(
    ...
    [l["Core/Color/Color.js"], l["Core/Globals.js"], l["Core/Utilities.js"]],
    function (f, e, l) {
      var P = f.parse,
        v = e.win,
        E = l.isNumber,
      ...
      return (function () {
        ...
        e.prototype.update = function () {
          ...
          if (this[t + "Setter"]) this[t + "Setter"]();
            ...
            e.attr
              ? e.element && e.attr(t, h, null, !0)
              : (e.style[t] = h + this.unit);
          d && d.call(e, h, this);
        };
        e.prototype.run = function (y, t, h) {
          ...
          y !== t || this.elem["forceAnimate:" + this.prop]
            ? ((this.startTime = +new Date()),
              ...
              (p.elem = this.elem),
              (p.prop = this.prop),
              p() && 1 === e.timers.push(p) && q(r))
            : (delete b.curAnim[this.prop],
              b.complete &&
                0 === Object.keys(b.curAnim).length &&
                b.complete.call(this.elem));
        };
        e.prototype.step = function (e) {
          ...
          if (d.attr && !d.element) e = !1;
            ...
            (this.pos = h.easing((t - this.startTime) / p)),
        ...
        e.prototype.initPath = function (e, t, h) {
          ...
          function b(b, m) {
            for (; b.length < z; )
              if (
                ((m = b[Math.floor(b.length / n) - 1].slice()),
        ...
        e.prototype.strokeSetter = function () {
          this.elem.attr(
            this.prop,
            P(this.start).tweenTo(P(this.end), this.pos),
            void 0,
            !0
          );
        };
  ...
  K(
    ...
    [l["Core/Animation/Fx.js"], l["Core/Utilities.js"]],
    function (f, e) {
      function l(b) {
        return y(b)
          ? t({ duration: 500, defer: 0 }, b)
      ...
      return {
        animate: function (b, d, q) {
          ...
          if (!y(q)) {
            var z = arguments;
            q = { duration: z[2], easing: z[3], complete: z[4] };
          }
          ...
          h(d, function (h, m) {
            ...
            p = void 0;
            "d" === m && G(d.d)
              ? ((w.paths = w.initPath(b, b.pathArray, d.d)),
                (w.toD = d.d),
                (r = 0),
                (p = 1))
              : b.attr
              ? (r = b.attr(m))
              : ((r = parseFloat(E(b, m)) || 0), "opacity" !== m && (n = "px"));
            p || (p = h);
            "string" === typeof p &&
              p.match("px") &&
              (p = p.replace(/px/g, ""));
        ...
        getDeferredAnimation: function (b, d, q) {
          ...
          return { defer: Math.max(0, n - p), duration: Math.min(n, p) };
        },
      ...
      B = (function () {
        ...
        q.filterUserAttributes = function (b) {
          t(b, function (d, p) {
            ...
            -1 !==
              ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(p) &&
              (n =
                y(d) &&
                q.allowedReferences.some(function (b) {
        ...
        q.prototype.addToDOM = function (b) {
          function d(b, p) {
            ...
            h(b).forEach(function (b) {
              var m = b.tagName,
                k = b.textContent
                  ? f.doc.createTextNode(b.textContent)
                  : void 0,
              ...
              if (m)
                if ("#text" === m) var g = k;
                  ...
                  d(b.children || [], m);
                  g = m;
                } else G(33, !1, void 0, { "Invalid tagName in config": m });
              g && p.appendChild(g);
              n = g;
            });
            return n;
    ...
    function (f, e) {
      function l(e, h, d, b) {
        ...
        if (-1 === h) h = Math.min(q, 20);
          ...
          var J = h + +r[1];
          0 <= J
            ? ((r[0] = (+r[0]).toExponential(J).split("e")[0]), (h = J))
            : ((r[0] = r[0].split(".")[0] || 0),
              (e = 20 > h ? (r[0] * Math.pow(10, r[1])).toFixed(h) : 0),
              (r[1] = 0));
        }
        J = (
          Math.abs(r[1] ? r[0] : e) + Math.pow(10, -Math.max(h, q) - 1)
        ).toFixed(h);
        q = String(y(J));
        ...
        e =
          0 > +r[1] && !n
            ? "0"
            : e + q.substr(w).replace(/(\d{3})(?=\d)/g, "$1" + b);
        h && (e += d + J.slice(-h));
        r[1] && 0 !== +e && (e += "e" + r[1]);
        return e;
      }
        ...
        function v(f, y, t) {
            ...
            for (q = f.length; q--; )
              (d = f[q]),
                (b =
                  ...
                  2),
                (d.pos = e(b - d.size * d.align, 0, y - d.size));
            q = f.length;
            for (r = !1; q--; )
              0 < q &&
                f[q - 1].pos + f[q - 1].size > f[q].pos &&
                ((f[q - 1].size += f[q].size),
                (f[q - 1].targets = f[q - 1].targets.concat(f[q].targets)),
                (f[q - 1].align = 0.5),
                f[q - 1].pos + f[q - 1].size > y &&
                  (f[q - 1].pos = y - f[q - 1].size),
                f.splice(q, 1),
                (r = !0));
          }
          h.push.apply(h, n);
          ...
          f.some(function (b) {
            ...
            return (b.targets || []).some(function () {
              ...
              if (
                "undefined" !== typeof t &&
                Math.abs(h[q].pos - h[q].target) > t
              )
                return (
                  h.slice(0, q + 1).forEach(function (b) {
                    return delete b.pos;
                  }),
                  (h.reducedLen = (h.reducedLen || y) - 0.1 * y),
                  h.reducedLen > 0.1 * y && v(h, y, t),
                  !0
                );
              d += h[q].size;
              q++;
    ...
    function (f, e, l, C, v) {
      ...
      f = (function () {
        ...
        f.prototype.align = function (a, g, I) {
          ...
          if (a) {
            if (
              ((this.alignOptions = a), (this.alignByTranslate = g), !I || c(I))
            )
              (this.alignTo = d = I || "renderer"),
                z(m, this),
                m.push(this),
                (I = void 0);
          } else
        ...
        f.prototype.animate = function (a, c, g) {
          ...
          0 !== b.duration
            ...
            : (this.attr(a, void 0, g || b.complete),
              A(
                a,
                function (a, c) {
                  b.step &&
                    b.step.call(this, a, { prop: c, pos: 1, elem: this });
                },
                this
              ));
          return this;
        ...
        f.prototype.attr = function (a, c, g, b) {
          ...
          "string" === typeof a
            ? (u = (this[a + "Getter"] || this._defaultGetter).call(this, a, I))
            : (A(
                a,
                function (c, g) {
                  F = !1;
                  ...
                  this.symbolName &&
                    -1 !== k.indexOf(g) &&
                    (H || (this.symbolAttr(a), (H = !0)), (F = !0));
                  !this.rotation ||
                    ("x" !== g && "y" !== g) ||
                    (this.doTransform = !0);
                  F ||
                    ((m = this[g + "Setter"] || this._defaultSetter),
                    m.call(this, c, g, I),
                    !this.styledMode &&
                      this.shadows &&
            ...
            if (u) {
              ...
              if (F[e]) z = F[e].attr("id");
                ...
                n.forEach(function (a) {
                  ...
                  a = b
                    .createElement("stop")
                    .attr({ offset: a[0], "stop-color": r, "stop-opacity": q })
                    .add(H);
                  H.stops.push(a);
                });
              }
        ...
        f.prototype.css = function (a) {
          ...
          if (k) {
            ...
            else if ("text" === b.nodeName.toLowerCase() && a.width)
              var u = (this.textWidth = L(a.width));
            this.styles = a;
            u && !d && this.renderer.forExport && delete a.width;
            var m = D(a);
            b.namespaceURI === this.SVG_NS &&
              ["textOutline", "textOverflow", "width"].forEach(function (a) {
                return m && delete m[a];
              });
            J(b, m);
            this.added &&
        ...
        f.prototype.destroy = function () {
          ...
          if (a.clipPath && b) {
            var u = a.clipPath;
            [].forEach.call(
              b.querySelectorAll("[clip-path],[CLIP-PATH]"),
              function (a) {
                -1 < a.getAttribute("clip-path").indexOf(u.element.id) &&
          ...
          a.safeRemoveChild(c);
          for (
            g.styledMode || a.destroyShadows();
            k && k.div && 0 === k.div.childNodes.length;

          )
            (c = k.parentGroup),
              a.safeRemoveChild(k.div),
              delete k.div,
              (k = c);
        ...
        f.prototype.getBBox = function (c, g) {
          ...
          var r = d.styledMode
              ? k && f.prototype.getStyle.call(k, "font-size")
              : m && m.fontSize,
            D;
          if (w(p)) {
            var q = p.toString();
              ...
              n &&
                (D.height = c =
                  { "11px,17": 14, "13px,20": 16 }[
                    "" + (r || "") + ",".concat(Math.round(c))
                  ] || c),
              g)
            ) {
              n = Number(k.getAttribute("y") || 0) - D.y;
              b = { right: 1, center: 0.5 }[b || 0] || 0;
              m = g * y;
              r = (g - 90) * y;
              var z = d * Math.cos(m);
              g = d * Math.sin(m);
        ...
        f.prototype.init = function (a, c) {
          this.element =
            "span" === c ? n(c) : t.createElementNS(this.SVG_NS, c);
          this.renderer = a;
          m(this, "afterInit");
        };
        ...
        f.prototype.removeClass = function (a) {
          return this.attr(
            "class",
            ("" + this.attr("class"))
              .replace(c(a) ? new RegExp("(^| )".concat(a, "( |$)")) : a, " ")
              .replace(/ +/g, " ")
              .trim()
          );
        };
        ...
        f.prototype.setTextPath = function (a, c) {
          ...
          if (a && c && c.enabled) {
            m && null === m.element.parentNode
              ? ((n = !0), (m = m.destroy()))
              : m && this.removeTextOutline.call(m.parentGroup);
            this.options &&
              this.options.padding &&
              (F.dx = -this.options.padding);
            m ||
              ((this.textPathWrapper = m =
                this.renderer.createElement("textPath")),
              (d = !0));
            var r = m.element;
            (c = a.element.getAttribute("id")) ||
              a.element.setAttribute("id", (c = R()));
            if (n)
              for (
                k.setAttribute("y", 0),
                  g(F.dx) && k.setAttribute("x", -F.dx),
                  a = [].slice.call(k.childNodes),
                  n = 0;
                n < a.length;
                n++
              ) {
                var q = a[n];
                (q.nodeType !== p.Node.TEXT_NODE && "tspan" !== q.nodeName) ||
                  r.appendChild(q);
              }
            d && m && m.add({ element: k });
            r.setAttributeNS(
        ...
        f.prototype.shadow = function (a, c, g) {
          ...
          F &&
            ...
            m && this.destroyShadows(),
            (this.oldShadowOptions = F));
          if (!F) this.destroyShadows();
          else if (!this.shadows) {
            var d = F.opacity / F.width;
            var p = this.parentInverted
              ? "translate(".concat(F.offsetY, ", ").concat(F.offsetX, ")")
              : "translate(".concat(F.offsetX, ", ").concat(F.offsetY, ")");
            for (u = 1; u <= F.width; u++) {
              var n = k.cloneNode(!1);
              ...
              n.setAttribute(
                "class",
                (n.getAttribute("class") || "") + " highcharts-shadow"
              );
              g &&
                (r(n, "height", Math.max(r(n, "height") - D, 0)),
                (n.cutHeight = D));
              c
                ? c.element.appendChild(n)
                : k.parentNode && k.parentNode.insertBefore(n, k);
              b.push(n);
            }
            this.shadows = b;
          }
        ...
        f.prototype.strokeSetter = function (a, c, g) {
          ...
          this.stroke && this["stroke-width"]
            ? (f.prototype.fillSetter.call(this, this.stroke, "stroke", g),
            ...
            : b &&
              d.push(
                "rotate(" +
                  b +
                  " " +
                  u(this.rotationOriginX, m.getAttribute("x"), 0) +
                  " " +
                  u(this.rotationOriginY, m.getAttribute("y") || 0) +
                  ")"
              );
        ...
        f.prototype.zIndexSetter = function (a, c) {
          ...
          var F;
          w(a)
            ? (u.setAttribute("data-z-index", a),
              (a = +a),
              this[c] === a && (m = !1))
            : w(this[c]) && u.removeAttribute("data-z-index");
          this[c] = a;
          if (m) {
            ...
            for (F = c.length - 1; 0 <= F && !d; F--) {
              ...
              if (b !== u)
                ...
                else if (L(m) <= a || (n && (!w(a) || 0 <= a)))
                  k.insertBefore(u, c[F + 1] || null), (d = !0);
            }
    ...
    function (f, e) {
      ...
      return (function (e) {
        function h(d, b, p, q, r, n, f, w, z, x) {
          ...
          m.className = x;
          m.addClass(
            "button" === x ? "highcharts-no-tooltip" : "highcharts-label"
          );
          x && m.addClass("highcharts-" + x);
          m.text = d.text(void 0, 0, 0, w).attr({ zIndex: 1 });
          var k;
          "string" === typeof r &&
            ((k = /^url\((.*?)\)$/.test(r)) || m.renderer.symbols[r]) &&
            (m.symbolKey = r);
          m.bBox = h.emptyBBox;
          m.padding = 3;
          m.baselineOffset = 0;
        ...
        h.prototype.paddingSetter = function (d, b) {
          E(d)
            ? d !== this[b] && ((this[b] = d), this.updateTextPadding())
            : (this[b] = void 0);
        };
        ...
        h.prototype.updateBoxSize = function () {
          ...
          this.baselineOffset =
            p +
            Math.min((this.text.firstLineMetrics || d).b, q.height || Infinity);
          this.heightSetting &&
          ...
          this.needsBox &&
            (this.box ||
              ...
              p.add(this)),
            (p = this.getCrispAdjust()),
            (b.x = p),
            (b.y = (this.baseline ? -this.baselineOffset : 0) + p),
            (b.width = Math.round(this.width)),
            (b.height = Math.round(this.height)),
            this.box.attr(v(b, this.deferredAttr)),
            (this.deferredAttr = {}));
        };
  ...
  K(l, "Core/Renderer/SVG/Symbols.js", [l["Core/Utilities.js"]], function (f) {
    function e(e, f, t, h, d) {
      ...
      if (d) {
        ...
        var r = (d.end || 0) - 0.001;
        h = d.innerR;
        var n = G(d.open, 0.001 > Math.abs((d.end || 0) - p - 2 * Math.PI)),
          J = Math.cos(p),
          w = Math.sin(p),
          z = Math.cos(r),
          x = Math.sin(r);
        p = G(d.longArc, 0.001 > r - p - Math.PI ? 0 : 1);
        b.push(
          ["M", e + q * J, f + t * w],
          ["A", q, t, 0, p, G(d.clockwise, 1), e + q * z, f + t * x]
        );
        v(h) &&
          b.push(
            n ? ["M", e + h * z, f + h * x] : ["L", e + h * z, f + h * x],
            [
              "A",
              h,
              h,
      ...
      return (function () {
        ...
        d.prototype.buildSVG = function () {
          ...
          if (z !== b.textCache) {
            ...
            this.ellipsis ||
            this.width ||
            (-1 !== r.indexOf(" ") && (!this.noWrap || w.test(r)))
              ? "" !== r &&
                (e && e.appendChild(d),
                (r = new f(r)),
                this.modifyTree(r.nodes),
                r.addToDOM(b.element),
                this.modifyDOM(),
                this.ellipsis &&
                  -1 !== (d.textContent || "").indexOf("\u2026") &&
                  b.attr(
                    "title",
                    this.unescapeEntities(b.textStr || "", ["&lt;", "&gt;"])
                  ),
                e && e.removeChild(d))
              : d.appendChild(P.createTextNode(this.unescapeEntities(r)));
            y(this.textOutline) &&
              b.applyTextOutline &&
        ...
        d.prototype.modifyDOM = function () {
          ...
          for (var r; (r = d.element.firstChild); )
            if (/^[\s\u200B]*$/.test(r.textContent || " "))
              d.element.removeChild(r);
            else break;
          [].forEach.call(
            ...
            function (n, r) {
              n.nextSibling &&
                ...
                G(n, { dy: b.getLineHeight(n.nextSibling), x: e }));
            }
          );
          var n = this.width || 0;
          if (n) {
            var h = function (r, p) {
                var m = r.textContent || "",
                  ...
                  a =
                    !b.noWrap &&
                    (1 < k.length || 1 < d.element.childNodes.length),
                  g = b.getLineHeight(p),
                  c = 0,
                  D = d.actualWidth;
                if (b.ellipsis)
                  m &&
                    b.truncate(
                      ...
                      void 0,
                      0,
                      Math.max(0, n - parseInt(b.fontSize || 12, 10)),
                      function (a, c) {
                  ...
                  for (; k.length; )
                    k.length &&
                      !b.noWrap &&
                      0 < c &&
                      (m.push(r.textContent || ""),
                      (r.textContent = k.join(" ").replace(/- /g, "-"))),
                      b.truncate(
                        r,
                        void 0,
                        k,
              ...
              f = function (b) {
                [].slice.call(b.childNodes).forEach(function (n) {
                  n.nodeType === E.Node.TEXT_NODE
                    ? h(n, b)
                    : (-1 !== n.className.baseVal.indexOf("highcharts-br") &&
                        (d.actualWidth = 0),
                      f(n));
                });
              };
        ...
        d.prototype.getLineHeight = function (b) {
          ...
          return this.textLineHeight
            ...
            : this.renderer.fontMetrics(d, b || this.svgElement.element).h;
        };
        d.prototype.modifyTree = function (b) {
          var d = this,
            e = function (r, n) {
              ...
              if ("b" === f || "strong" === f)
                m
                  ? (p["class"] = "highcharts-strong")
                  : (q.fontWeight = "bold");
              else if ("i" === f || "em" === f)
                m
                  ? (p["class"] = "highcharts-emphasized")
                  : (q.fontStyle = "italic");
              q && q.color && (q.fill = q.color);
              "br" === f
                ? ((p["class"] = "highcharts-br"),
                  (r.textContent = "\u200b"),
                  (n = b[n + 1]) &&
                    n.textContent &&
                ...
                : "a" === f &&
                  ...
                  (r.children = [{ children: h, tagName: "tspan" }]);
              "#text" !== f && "a" !== f && (r.tagName = "tspan");
              B(r, { attributes: p, style: q });
              h &&
                h
                  .filter(function (b) {
                    return "#text" !== b.tagName;
            ...
            D = function (a, c) {
              ...
              if (g && "undefined" === typeof m[c])
                if (g.getSubStringLength)
                  ...
                  f.getSpanWidth &&
                    ((b.textContent = h(d || e, a)),
                    (m[c] = r + f.getSpanWidth(p, b)));
              return m[c];
            };
          p.rotation = 0;
          ...
          if (r + A > n) {
            for (; k <= a; )
              (g = Math.ceil((k + a) / 2)),
                e && (c = h(e, g)),
                (A = D(g, c && c.length - 1)),
                k === a ? (k = a + 1) : A > n ? (a = g - 1) : (k = g);
            0 === a
              ? (b.textContent = "")
              : (d && a === d.length - 1) ||
                (b.textContent = c || h(d || e, g));
          }
          e && e.splice(0, g);
          p.actualWidth = A;
          p.rotation = q;
        ...
        d.prototype.unescapeEntities = function (b, d) {
          t(this.renderer.escapes, function (e, r) {
            (d && -1 !== d.indexOf(e)) ||
              (b = b.toString().replace(new RegExp(e, "g"), r));
          });
          return b;
        };
        return d;
  ...
  K(
    ...
    [
      ...
      l["Core/Renderer/SVG/SVGLabel.js"],
      l["Core/Renderer/SVG/Symbols.js"],
      l["Core/Renderer/SVG/TextBuilder.js"],
      l["Core/Utilities.js"],
    ],
      ...
      l = (function () {
        ...
        I.prototype.init = function (a, c, g, m, u, F, I) {
          ...
          this.createElement("desc")
            .add()
            .element.appendChild(
              d.createTextNode("Created with Highcharts 10.2.0")
            );
          ...
          b &&
            ...
            c(),
            (this.unSubPixelFix = z(w, "resize", c)));
        };
        ...
        I.prototype.getReferenceURL = function () {
          if ((b || q) && d.getElementsByTagName("base").length) {
            if (!a(aa)) {
              ...
              k(c, { position: "fixed", top: 0, left: 0, zIndex: 9e5 });
        ...
        I.prototype.getContrast = function (a) {
          ...
          return 1.05 / (a + 0.05) > (a + 0.05) / 0.05 ? "#FFFFFF" : "#000000";
        };
        I.prototype.button = function (a, g, b, d, k, m, I, n, e, r) {
          ...
          F.attr(S({ padding: 8, r: 2 }, h));
          if (!D) {
            h = S({ fill: "#f7f7f7", stroke: "#cccccc", "stroke-width": 1 }, h);
            m = S(
              h,
              { fill: "#e6e6e6" },
          ...
          D || F.attr(h).css(c({ cursor: "default" }, H));
        ...
        I.prototype.crispLine = function (c, g, b) {
          ...
          a(d[1]) &&
            d[1] === k[1] &&
            (d[1] = k[1] = Math[b](d[1]) - (g % 2) / 2);
          a(d[2]) &&
            d[2] === k[2] &&
            (d[2] = k[2] = Math[b](d[2]) + (g % 2) / 2);
          return c;
        };
        ...
        I.prototype.arc = function (a, c, g, b, d, k) {
          u(a)
            ? ((b = a), (c = b.y), (g = b.r), (a = b.x))
            : (b = { innerR: b, start: d, end: k });
        ...
        I.prototype.symbol = function (g, b, u, I, n, F) {
          ...
          if (A) {
            ...
            c(f, { symbolName: p || void 0, x: b, y: u, width: I, height: n });
            F && c(f, F);
          } else if (D) {
            var q = g.match(r)[1];
            ...
            var z = function (a) {
              return a.attr({ width: a.width, height: a.height });
            };
            ["width", "height"].forEach(function (c) {
              H[c + "Setter"] = function (c, g) {
                ...
                a(b) &&
                  ...
                  this.element && this.element.setAttribute(g, b),
                  this.alignByTranslate ||
                    ((c = ((this[g] || 0) - b) / 2),
                    this.attr(
                      "width" === g ? { translateX: c } : { translateY: c }
                    )));
              };
            });
            a(b) && H.attr({ x: b, y: u });
            H.isImg = !0;
            a(H.imgwidth) && a(H.imgheight)
              ? z(H)
              : (H.attr({ width: 0, height: 0 }),
                m("img", {
                  onload: function () {
                    ...
                    J[q] = { width: this.width, height: this.height };
        ...
        I.prototype.text = function (c, g, b, d) {
          ...
          if (d && (this.allowHTML || !this.forExport))
            return this.html(c, g, b);
          k.x = Math.round(g || 0);
          b && (k.y = Math.round(b));
          a(c) && (k.text = c);
          c = this.createElement("text").attr(k);
          if (!d || (this.forExport && !this.allowHTML))
            c.xSetter = function (a, c, g) {
              for (
                var b = g.getElementsByTagName("tspan"),
                  d = g.getAttribute(c),
                  k = 0,
                  m;
                k < b.length;
        ...
        I.prototype.fontMetrics = function (a, c) {
          a =
            (!this.styledMode && /px/.test(a)) || !w.getComputedStyle
              ? a ||
                (c && c.style && c.style.fontSize) ||
                (this.style && this.style.fontSize)
              : c && v.prototype.getStyle.call(c, "font-size");
          a = /px/.test(a) ? M(a) : 12;
        ...
        I.prototype.pathToSegments = function (a) {
          for (
            var c = [],
              g = [],
              b = { A: 8, C: 7, H: 2, L: 3, M: 3, Q: 5, S: 5, T: 3, V: 2 },
              d = 0;
            d < a.length;
            d++
          )
            L(g[0]) &&
              ...
              a.splice(d, 0, g[0].replace("M", "L").replace("m", "l")),
              "string" === typeof a[d] &&
    ...
    function (f, e, l) {
      ...
      return (function (e) {
        ...
        p.prototype.htmlUpdateTransform = function () {
          if (this.added) {
            var d = this.renderer,
              ...
              k = { left: 0, center: 0.5, right: 1 }[m],
              a = this.styles;
            a = a && a.whiteSpace;
            y(n, { marginLeft: e, marginTop: p });
            !d.styledMode &&
              this.shadows &&
              this.shadows.forEach(function (a) {
                y(a, {
            ...
            this.inverted &&
              [].forEach.call(n.childNodes, function (a) {
                d.invertChild(a, n);
              });
            if ("SPAN" === n.tagName) {
              var g = this.rotation,
              ...
              if (c !== this.oldTextWidth) {
                if (this.textPxLength) var u = this.textPxLength;
                  ...
                  y(n, { width: "", whiteSpace: a || "nowrap" }),
                    (u = n.offsetWidth);
                (c > this.oldTextWidth || u > c) &&
              ...
              D !== this.cTT &&
                ((A = d.fontMetrics(n.style.fontSize, n).b),
                !t(g) ||
                  (g === (this.oldRotation || 0) && m === this.oldAlign) ||
                  this.setSpanRotation(g, k, A),
                this.getSpanCorrection(
                  (!t(g) && this.textPxLength) || n.offsetWidth,
                  A,
                  k,
                  g,
                  m
        ...
        p.prototype.setSpanRotation = function (b, d, e) {
          var n = {},
            p =
              E && !/Edge/.test(B.navigator.userAgent)
                ? "-ms-transform"
                : G
                ? "-webkit-transform"
                : v
                ...
                : void 0;
          p &&
            ((n[p] = n.transform = "rotate(" + b + "deg)"),
            (n[p + (v ? "Origin" : "-origin")] = n.transformOrigin =
              100 * d + "% " + e + "px"),
            y(this.element, n));
        };
        p.composedClasses = [];
        ...
        h.prototype.html = function (d, b, p) {
          ...
          h.textSetter = function (b) {
            b !== this.textStr &&
              ...
              f.setElementHTML(this.element, y(b, "")),
              (this.textStr = b),
              (h.doTransform = !0));
          };
          ...
          h.attr({ text: d, x: Math.round(b), y: Math.round(p) }).css({
            position: "absolute",
          });
          n.styledMode ||
            h.css({
    ...
    (function (f) {
      f.registerEventOptions = function (f, y) {
        ...
        C(y.events, function (t, h) {
          f.eventOptions[h] !== t &&
            (f.eventOptions[h] &&
              (v(f, h, f.eventOptions[h]), delete f.eventOptions[h]),
            l(t) && ((f.eventOptions[h] = t), e(f, h, t)));
        });
      };
    })(E || (E = {}));
    return E;
    ...
    function (f, e, l) {
      ...
      e = (function () {
        ...
        e.prototype.addLabel = function () {
          ...
          if (d.dateTime)
            if (g) {
              var S = q.time.resolveDTLFormat(
                e.dateTimeLabelFormats[
                  (!e.grid && g.higherRanks[k]) || g.unitName
                ]
              );
              var R = S.main;
            } else
              h(z) &&
                (R = d.dateTime.getXDateFormat(
                  z,
                  e.dateTimeLabelFormats || {}
                ));
          b.isFirst = c;
          ...
          var B = function (c) {
            return a.formatter
              ? a.formatter.call(c, c)
              : a.format
              ? ((c.text = d.defaultLabelFormatter.call(c)),
                f.format(a.format, c, q))
          ...
          b.shortenLabel = aa
            ? function () {
                for (l = 0; l < aa.length; l++)
                  if (
                    (y(M, { dateTimeLabelFormat: aa[l] }),
                    u.attr({ text: B.call(M, M) }),
                    u.getBBox().width < d.getSlotWidth(b) - 2 * a.padding)
                  )
                    return;
                u.attr({ text: "" });
              }
          ...
          G(u) || b.movedLabel
            ...
            : ((b.label = u = b.createLabel({ x: 0, y: 0 }, e, a)),
              (b.rotation = 0));
        };
        e.prototype.createLabel = function (b, e, p) {
          ...
          if (
            (b =
              G(e) && p.enabled
                ? h.renderer.text(e, b.x, b.y, p.useHTML).add(n.labelGroup)
                : null)
          )
            h.styledMode || b.css(d(p.style)),
        ...
        e.prototype.getPosition = function (b, d, e, p) {
          ...
          b = {
            x: b
              ? E(n.translate(d + e, void 0, void 0, p) + n.transB)
              : n.left +
                n.offset +
                (n.opposite
                  ? ((p && h.oldChartWidth) || h.chartWidth) - n.right - n.left
                  : 0),
            y: b
              ? m - n.bottom + n.offset - (n.opposite ? n.height : 0)
              : E(m - n.translate(d + e, void 0, void 0, p) - n.transB),
          };
          b.y = v(b.y, -1e5, 1e5);
          t(this, "afterGetPosition", { pos: b });
          return b;
        };
        e.prototype.getLabelPosition = function (b, d, e, p, h, f, m, k) {
          ...
          e =
            0 === a.side
              ...
              : 2 === a.side
              ? A.y + 8
              : Math.cos(e.rotation * C) * (A.y - e.getBBox(!1, 0).height / 2);
        ...
        e.prototype.handleOverflow = function (b) {
          ...
          r = p(
            d.labelRight,
            Math.max(d.isRadial ? 0 : d.pos + d.len, f - r[1])
          );
          var k = this.label,
            a = this.rotation,
            ...
            q = 1,
            l;
          if (a || "justify" !== e.overflow)
            0 > a && h - g * c < m
              ? (l = Math.round(h / Math.cos(a * C) - m))
              : 0 < a &&
                h + g * c > r &&
                (l = Math.round((f - h) / Math.cos(a * C)));
          else if (
            ((f = h + (1 - g) * c),
            h - g * c < m
              ? (u = b.x + u * (1 - g) - m)
            ...
            u < D &&
              "center" === d.labelAlign &&
              (b.x += q * (D - u - g * (D - Math.min(c, u)))),
            c > u || (d.autoRotation && (k.styles || {}).width))
          )
            l = u;
          l &&
            (this.shortenLabel
              ? this.shortenLabel()
              : ((A.width = Math.floor(l) + "px"),
                (e.style || {}).textOverflow || (A.textOverflow = "ellipsis"),
                k.css(A)));
        };
        e.prototype.moveLabel = function (d, e) {
          var h = this,
            ...
            m = !1;
          p && p.textStr === d
            ? ((h.movedLabel = p), (m = !0), delete h.label)
            : b(n.ticks, function (a) {
                m ||
                  a.isNew ||
                  a === h ||
                  !a.label ||
                  a.label.textStr !== d ||
                  ((h.movedLabel = a.label),
                  (m = !0),
                  (a.labelPos = h.movedLabel.xy),
                  delete a.label);
              });
          if (!m && (h.labelPos || p)) {
            ...
            h.movedLabel = h.createLabel({ x: p, y: n }, d, e);
        ...
        e.prototype.renderGridLine = function (b, d, e) {
          ...
          "minor" === this.type &&
            ((D = n.minorGridLineWidth),
            (A = n.minorGridLineColor),
            (u = n.minorGridLineDashStyle));
          c ||
            (h.chart.styledMode ||
              ((f.stroke = A), (f["stroke-width"] = D || 0), (f.dashstyle = u)),
            k || (f.zIndex = 1),
            b && (d = 0),
            (this.gridLine = c =
              g
          ...
          if (
            ...
            c[b || this.isNew ? "attr" : "animate"]({ d: e, opacity: d });
        };
            ...
            c ||
              ((this.mark = c =
                f
                  ...
                  .add(h.axisGroup)),
              h.chart.styledMode || c.attr({ stroke: n, "stroke-width": g })),
            c[D ? "attr" : "animate"]({
        ...
        e.prototype.renderLabel = function (b, d, e, f) {
          ...
          k &&
            h(c) &&
            ((k.xy = b = this.getLabelPosition(c, b, k, r, a, n, f, g)),
            ...
            (this.isLast && !this.isFirst && !m.showLastLabel)
              ...
              : !r ||
                ...
                d ||
                0 === e ||
                this.handleOverflow(b),
            g && f % g && (D = !1),
            D && h(b.y)
              ? ((b.opacity = e),
                k[this.isNewLabel ? "attr" : "animate"](b).show(!0),
                (this.isNewLabel = !1))
              : (k.hide(), (this.isNewLabel = !0)));
        };
        e.prototype.replaceMovedLabel = function () {
          ...
          if (b && !this.isNew) {
            ...
            b.animate({ x: h, y: e, opacity: 0 }, void 0, b.destroy);
            delete this.label;
          }
          d.isDirty = !0;
      ...
      var y = f.animObject,
        ...
        U = function (a, c) {
          return D(
            ...
            void 0,
            void 0,
            u(a.options.allowDecimals, 0.5 > c || void 0 !== a.tickAmount),
            !!a.tickAmount
          );
        };
      f = (function () {
        ...
        f.prototype.setOptions = function (a) {
          ...
          m(this, "afterSetOptions", { userOptions: a });
        };
            ...
            for (; h-- && "undefined" === typeof f; )
              (b = Math.pow(e, h + 1)),
                u >= b &&
                  ...
                  (f = c(g / b, -1) + m[h]);
          "undefined" === typeof f &&
            (f = 1e4 <= Math.abs(g) ? c(g, -1) : c(g, -1, void 0, ""));
          return f;
        };
                ...
                if (c.isXAxis) {
                  if (((k = d.xData), k.length)) {
                    ...
                    a(m) ||
                      ...
                      (h = g.max));
                    k.length &&
                      ((c.dataMin = Math.min(u(c.dataMin, m), m)),
                      (c.dataMax = Math.max(u(c.dataMax, h), h)));
                  }
                } else if (
                  ((d = d.applyExtremes()),
                  a(d.dataMin) &&
        ...
        f.prototype.translate = function (c, b, g, d, k, e) {
          ...
          k =
            (m.isOrdinal ||
              (m.brokenAxis && m.brokenAxis.hasBreaks) ||
              (m.logarithmic && k)) &&
            m.lin2val;
          var f = 1,
            p = 0;
          ...
          b
            ? ((e = (c * f + p - h) / d + u), k && (e = m.lin2val(e)))
            : (k && (c = m.val2lin(c)),
              (c = f * (c - u) * d),
              (e = (m.isRadial ? c : r(c)) + p + f * h + (a(e) ? d * e : 0)));
          return e;
        };
        f.prototype.toPixels = function (a, c) {
          return (
            this.translate(a, !1, !this.horiz, void 0, !0) + (c ? 0 : this.pos)
          );
        };
        ...
        f.prototype.getPlotLinePath = function (c) {
          ...
          m(this, "getPlotLinePath", c, function (c) {
            ...
            a(A)
              ? g.horiz
                ? ((t = e), (z = n - g.bottom), (l = x = b(l, k, k + g.width)))
                : ((l = k), (x = I - g.right), (t = z = b(t, e, e + g.height)))
              : ((L = !0), (r = !1));
            c.path =
              L && !r
                ? null
        ...
        f.prototype.getMinorTickPositions = function () {
          ...
          if (k && k / g < this.len / 3) {
            ...
            if (e)
              this.paddedTicks.forEach(function (a, c, b) {
                c &&
                  m.push.apply(m, e.getLogTickPositions(g, b[c - 1], b[c], !0));
              });
        ...
        f.prototype.adjustForMinRange = function () {
          ...
          this.isXAxis &&
            ...
            !c &&
            (n(a.min) || n(a.max) || n(a.floor) || n(a.ceiling)
              ? (this.minRange = null)
        ...
        f.prototype.setAxisTranslation = function () {
          ...
          if (k || d || e) {
            var n = a.getClosest();
            b
              ? ((h = b.minPointOffset), (f = b.pointRangePadding))
              : a.series.forEach(function (c) {
                  var b = d
                      ? 1
                      : k
                      ? u(c.options.pointRange, n, 0)
                      : a.axisPointRange || 0,
                    m = c.options.pointPlacement;
                  e = Math.max(e, b);
                  if (!a.single || d)
                    (c = c.is("xrange") ? !k : k),
                      (h = Math.max(h, c && g(m) ? 0 : b / 2)),
                      (f = Math.max(f, c && "on" === m ? 0 : b));
                });
        ...
        f.prototype.setTickInterval = function (c) {
          var g = this.chart,
            ...
            D = d.minPadding,
            I =
              a(d.tickInterval) && 0 <= d.tickInterval
                ? d.tickInterval
                : void 0,
          ...
          b &&
            (this.positiveValuesOnly &&
              ...
              z(10, 1, g),
            (this.min = r(b.log2lin(this.min), 16)),
            (this.max = r(b.log2lin(this.max), 16)));
          this.range &&
            n(this.max) &&
            ((this.userMin =
              this.min =
          ...
          !(
            ...
            !n(t) && A && (this.max += g * A));
          a(this.userMin) ||
            (a(d.softMin) && d.softMin < this.min && (this.min = l = d.softMin),
            a(d.floor) && (this.min = Math.max(this.min, d.floor)));
          a(this.userMax) ||
            (a(d.softMax) && d.softMax > this.max && (this.max = t = d.softMax),
            a(d.ceiling) && (this.max = Math.min(this.max, d.ceiling)));
          p &&
            n(this.dataMin) &&
            ((q = q || 0),
            !n(l) && this.min < q && this.dataMin >= q
          ...
          if (k && !c) {
            ...
            m(this, "postProcessData", { hasExtemesChanged: w });
          }
          ...
          if (!g) {
            if (
              ...
              if (this.dateTime)
                ...
                g = this.logarithmic.getLogTickPositions(
                  this.tickInterval,
                  this.min,
                  this.max
                );
                ...
                for (var e = (a = this.tickInterval); e <= 2 * a; )
                  if (
                    ((g = this.getLinearTickPositions(
                      this.tickInterval,
                      this.min,
                      this.max
                    )),
                    this.tickAmount && g.length > this.tickAmount)
                  )
                    this.tickInterval = U(this, (e *= 1.1));
                  else break;
        ...
        f.prototype.alignToOthers = function () {
          ...
          if (
            ((!1 !== this.chart.options.chart.alignTicks && b.alignTicks) ||
              d) &&
            !1 !== b.startOnTick &&
            !1 !== b.endOnTick &&
            !c.logarithmic
        ...
        f.prototype.adjustTickAmount = function () {
          ...
          if (a(h)) {
            var D = 0.5 > h ? Math.ceil(h * (e - 1)) : Math.floor(h * (e - 1));
            k.reversed && (D = e - 1 - D);
          }
          if (c.hasData() && a(d) && a(b)) {
            h = function () {
              ...
              c.max = k.endOnTick
                ? m[m.length - 1]
                : Math.max(b, m[m.length - 1]);
            };
            if (a(D) && a(c.threshold)) {
              for (
                ;
                m[D] !== p || m.length !== e || m[0] > d || m[m.length - 1] < b;

              ) {
                m.length = 0;
                for (m.push(c.threshold); m.length < e; )
                  void 0 === m[D] || m[D] > c.threshold
                    ? m.unshift(r(m[0] - A))
                    : m.push(r(m[m.length - 1] + A));
          ...
          m(this, "zoom", a, function (a) {
            ...
            if (c !== g.min || k !== g.max)
              g.allowZoomOutside ||
                ...
                g.setExtremes(c, k, !1, void 0, { trigger: "zoom" });
            a.zoomed = !0;
          });
          return a.zoomed;
        };
        f.prototype.setAxisSize = function () {
          var a = this.chart,
            ...
            d = (this.width = Math.round(
              L(u(c.width, a.plotWidth - g[3] + g[1]), a.plotWidth)
            )),
            k = (this.height = Math.round(
              L(u(c.height, a.plotHeight - g[0] + g[2]), a.plotHeight)
            )),
            m = (this.top = Math.round(
              L(u(c.top, a.plotTop + g[0]), a.plotHeight, a.plotTop)
            ));
          c = this.left = Math.round(
            L(u(c.left, a.plotLeft + g[3]), a.plotWidth, a.plotLeft)
          );
        ...
        f.prototype.renderUnsquish = function () {
          ...
          b.forEach(function (a) {
            ...
            a &&
              a.label &&
              a.label.textPxLength > A &&
              (A = a.label.textPxLength);
          });
              ...
              for (u = b.length; !e && u--; ) {
                ...
                if ((q = d[q].label))
                  q.styles && "ellipsis" === q.styles.textOverflow
                    ...
                    : q.textPxLength > h && q.css({ width: h + "px" }),
                    q.getBBox().height > this.len / b.length - (p.h - p.f) &&
                      (q.specificTextOverflow = "ellipsis");
              }
            }
          }
          f.rotation &&
            ((D = A > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : A),
            n || (r = "ellipsis"));
          if (
            (this.labelAlign =
            ...
            c &&
              ...
              a.shortenLabel
                ...
                : D &&
                  !g &&
                  "nowrap" !== m.whiteSpace &&
                  (D < c.textPxLength || "SPAN" === c.element.tagName)
                ? ((b.width = D + "px"),
                  n || (b.textOverflow = c.specificTextOverflow || r),
                  c.css(b))
                : c.styles &&
                  c.styles.width &&
                  !b.width &&
        ...
        f.prototype.addTitle = function (a) {
          ...
          this.axisTitle ||
            ...
            m || this.axisTitle.css(c(k.style)),
        ...
        f.prototype.getOffset = function () {
          ...
          if (!c.axisGroup) {
            var J = function (c, g, b) {
              return D.g(c)
                .attr({ zIndex: b })
                .addClass(
                  "highcharts-".concat(f.toLowerCase()).concat(g, " ") +
                    (a.isRadial
                      ? "highcharts-radial-axis".concat(g, " ")
                      : "") +
                    (L || "")
                )
                .add(p);
          ...
          if (
            ...
            l.text &&
            !1 !== l.enabled &&
            (c.addTitle(w), w && !1 !== l.reserveSpace)
          ) {
          ...
          "colorAxis" !== f &&
            ...
            (x[k] = Math.max(
              x[k],
              (c.axisTitleMargin || 0) + S + z * c.offset,
              r,
              h && h.length && b ? b[0] + z * c.offset : 0
            )),
            (d =
              !c.axisLine || d.offset
                ? 0
        ...
        f.prototype.getLinePath = function (a) {
          ...
          return c.renderer.crispLine(
            [
              ["M", d ? this.left : k, d ? b : this.top],
              [
                "L",
                d ? c.chartWidth - this.right : k,
                d ? b : c.chartHeight - this.bottom,
              ],
            ],
            a
          );
        ...
        f.prototype.getTitlePosition = function () {
          ...
          c =
            (a ? g + this.height : c) +
            (a ? 1 : -1) * (e ? -1 : 1) * (this.axisTitleMargin || 0) +
            [-p, p, n.f, -p][this.side];
          a = {
            x: a ? b + f : c + (e ? this.width : 0) + h + f,
            y: a ? c + u - (e ? this.height : 0) + h : b + u,
          };
          m(this, "afterGetTitlePosition", { titlePosition: a });
          return a;
        };
        ...
        f.prototype.render = function () {
          ...
          if (c.hasData() || k) {
            ...
            e.length &&
              ...
              r &&
                (0 === c.min || c.single) &&
                (f[-1] || (f[-1] = new G(c, -1, null, !0)), f[-1].render(-1)));
            D &&
              e.forEach(function (a, d) {
                ...
                0 === d % 2 &&
                  a < c.max &&
                  z <= c.max + (g.polar ? -r : r) &&
                  (p[a] || (p[a] = new E.PlotLineOrBand(c)),
                  (x = a + r),
                  (p[a].options = {
        ...
        f.prototype.drawCrosshair = function (a, c) {
          var g = this.crosshair,
            ...
            k,
            e = this.cross;
          m(this, "drawCrosshair", { e: a, point: c });
                ...
                (e
                  .attr({
                    stroke:
                      g.color ||
                      (b
                        ? l.parse("#ccd6eb").setOpacity(0.25).get()
                        : "#cccccc"),
                    "stroke-width": u(g.width, 1),
                  })
                  .css({ "pointer-events": "none" }),
                g.dashStyle && e.attr({ dashstyle: g.dashStyle })));
            e.show().attr({ d: h });
            b && !g.width && e.attr({ "stroke-width": this.transA });
            this.cross.e = a;
          } else this.hideCrosshair();
          m(this, "afterDrawCrosshair", { e: a, point: c });
        };
        ...
        f.prototype.remove = function (a) {
          for (
            var c = this.chart, g = this.coll, b = this.series, d = b.length;
            d--;
      ...
      var h = (function () {
        ...
        d.prototype.normalizeTimeTickInterval = function (b, d) {
          ...
          for (
            ...
            (h = v[d[0]]),
            (f = d[1]),
            e[p + 1] && b <= (h * f[f.length - 1] + v[e[p + 1][0]]) / 2);
            p++
          );
          h === v.year && b < 5 * h && (f = [1, 2, 5]);
          b = C(b / h, f, "year" === d[0] ? Math.max(l(b / h), 1) : 1);
          return { unitRange: h, count: b, unitName: d[0] };
        };
        d.prototype.getXDateFormat = function (b, d) {
          ...
          return e.closestPointRange
            ? h.getDateFormat(
                ...
                d
              ) || h.resolveDTLFormat(d.year).main
    ...
    (function (f) {
      ...
      var t = (function () {
        ...
        e.prototype.getLogTickPositions = function (d, b, e, h) {
          ...
          if (0.5 <= d)
            (d = Math.round(d)), (t = f.getLinearTickPositions(d, b, e));
          else if (0.08 <= d) {
            var z = Math.floor(b),
              x,
              m = (q = void 0);
            ...
            (b = this.lin2log(b)),
              (e = this.lin2log(e)),
              (d = h ? f.getMinorTickInterval() : q.tickInterval),
              (d = C(
                "auto" === d ? null : d,
                this.minorAutoInterval,
                ((q.tickPixelInterval / (h ? 5 : 1)) * (e - b)) /
                  ((h ? p / f.tickPositions.length : p) || 1)
              )),
              (d = l(d)),
              (t = f.getLinearTickPositions(d, b, e).map(this.log2lin)),
              h || (this.minorAutoInterval = d / 5);
          h || (f.tickInterval = d);
          return t;
        };
        ...
        var y = (function () {
          ...
          f.prototype.getPlotBandPath = function (e, d, b) {
            ...
            d =
              !C(this.min) ||
              !C(this.max) ||
              (e < this.min && d < this.min) ||
              (e > this.max && d > this.max);
  ...
  K(
    ...
    [
      l["Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js"],
      l["Core/Utilities.js"],
    ],
    function (f, e) {
      var l = e.arrayMax,
      ...
      e = (function () {
        ...
        d.prototype.render = function () {
          ...
          x.zIndex = w;
          M += "-" + w;
          (f = d.plotLinesAndBandsGroups[M]) ||
            (d.plotLinesAndBandsGroups[M] = f =
              m
                .g("plot-" + M)
                .attr(x)
                .add());
          ...
          (S || !A.d) && u && u.length
            ...
            : A &&
              (u
                ? (A.show(), A.animate({ d: u }))
                : A.d && (A.hide(), a && (b.label = a = a.destroy())));
          k &&
          (v(k.text) || v(k.formatter)) &&
          u &&
          u.length &&
          0 < d.width &&
          0 < d.height &&
        ...
        d.prototype.renderLabel = function (b, d, e, f) {
          ...
          r ||
            ((this.label = r =
              p
                .text(this.getLabelText(b), 0, 0, b.useHTML)
                .attr({
                ...
                .add()),
            h.chart.styledMode ||
              r.css(y({ textOverflow: "ellipsis" }, b.style)));
          f = d.xBounds || [d[0][1], d[1][1], e ? d[2][1] : d[0][1]];
          d = d.yBounds || [d[0][2], d[1][2], e ? d[2][2] : d[0][2]];
          e = C(f);
          p = C(d);
          r.align(b, !1, { x: e, y: p, width: l(f) - e, height: l(d) - p });
          (r.alignValue && "left" !== r.alignValue) ||
            r.css({
              width:
                (90 === r.rotation
                  ? h.height - (r.alignAttr.y - h.top)
                  : h.width - (r.alignAttr.x - h.left)) + "px",
            });
          r.show(!0);
        };
      ...
      f = (function () {
        ...
        k.prototype.getAnchor = function (a, g) {
          ...
          this.followPointer && g
            ? ("undefined" === typeof g.chartX && (g = b.normalize(g)),
              (b = [g.chartX - e, g.chartY - k]))
            : a[0].tooltipPos
            ? (b = a[0].tooltipPos)
            : (a.forEach(function (a) {
                m = a.series.yAxis;
                ...
                f &&
                  m &&
                  (d
                    ? ((h += k + c.plotHeight - f.len - f.pos),
                      (p += e + c.plotWidth - m.len - m.pos))
                    : ((h += f.pos - e), (p += m.pos - k)));
              }),
              (h /= a.length),
              (p /= a.length),
              (b = [d ? c.plotWidth - p : h, d ? c.plotHeight - h : p]),
              this.shared &&
                1 < a.length &&
                g &&
                (d ? (b[0] = g.chartX - e) : (b[1] = g.chartY - k)));
        ...
        k.prototype.getLabel = function () {
          var a = this,
            ...
            m =
              ...
              (!this.followPointer && c.stickOnContact ? "auto" : "none"),
            f = function () {
              a.inContact = !0;
            },
            p = function (c) {
              ...
              a.inContact =
                ...
                a.chart.pointer.inClass(c.relatedTarget, "highcharts-tooltip");
          ...
          if (!this.label) {
            ...
            b
              ...
              : ((this.label = r
                  ...
                  .attr({ padding: c.padding, r: c.borderRadius })),
                g ||
                  this.label
                    .attr({
        ...
        k.prototype.getPosition = function (a, g, c) {
          var b = this.chart,
            ...
            n = function (k) {
              var e = "x" === k;
              return [k, e ? f : h, e ? a : g].concat(
                m
                  ? [
                      e ? a * p.scaleX : g * p.scaleY,
                      e
                        ? p.left - d + (c.plotX + b.plotLeft) * p.scaleX
                        : p.top - d + (c.plotY + b.plotTop) * p.scaleY,
                      0,
                      e ? f : h,
                    ]
                  : [
                      e ? a : g,
                      e ? c.plotX + b.plotLeft : c.plotY + b.plotTop,
                      e ? b.plotLeft : b.plotTop,
                      e ? b.plotLeft + b.plotWidth : b.plotTop + b.plotHeight,
                    ]
              );
            },
            r = n("y"),
        ...
        k.prototype.move = function (a, g, c, b) {
          var d = this,
            ...
            e =
              ...
              !d.isHidden &&
              (1 < Math.abs(a - k.x) || 1 < Math.abs(g - k.y)),
        ...
        k.prototype.refresh = function (a, g) {
          ...
          if (b.enabled && k.series) {
            ...
            this.followPointer =
              !this.split && k.series.tooltipOptions.followPointer;
            a = this.getAnchor(a, g);
            var n = a[0],
              l = a[1];
            f && this.allowShared
              ? (c.pointer.applyInactiveState(d),
                d.forEach(function (a) {
                  a.setState("hover");
                  e.push(a.getLabelConfig());
                }),
                (p = { x: k.category, y: k.y }),
                (p.points = e))
              : (p = k.getLabelConfig());
            this.len = e.length;
            m = m.call(p, this);
            ...
            if (!1 === m) this.hide();
              ...
              if (this.split && this.allowShared) this.renderSplit(m, d);
                ...
                g &&
                  ...
                  ((t = g.chartX - c.plotLeft), (w = g.chartY - c.plotTop));
                if (
                  c.polar ||
                  !1 === f.options.clip ||
                  d.some(function (a) {
                  ...
                  (g = this.getLabel()),
                    ...
                    g.attr({ text: m && m.join ? m.join("") : m }),
                    g
                      .removeClass(/highcharts-color-[\d]+/g)
                      .addClass(
                        "highcharts-color-" + z(k.colorIndex, f.colorIndex)
                      ),
                    h ||
                      g.attr({
                        stroke:
                          b.borderColor || k.color || f.color || "#666666",
                      }),
                    this.updatePosition({
                      plotX: n,
                      plotY: l,
        ...
        k.prototype.renderSplit = function (a, g) {
          function c(a, c, g, d, k) {
            ...
            g
              ? ((c = X ? 0 : E),
                (a = t(a - d / 2, N.left, N.right - d - (b.outside ? Q : 0))))
              : ((c -= Z),
                (a = k ? a - d - v : a + v),
                (a = t(a, k ? a : N.left, N.right)));
            return { x: a, y: c };
          }
          var b = this,
            d = b.chart,
          ...
          var y = k.styledMode,
            ...
            N =
              b.outside && "number" !== typeof l
                ? G.documentElement.getBoundingClientRect()
                : { left: w, right: w + e, top: x, bottom: x + m },
            V = b.getLabel(),
          ...
          a = a.slice(0, g.length + 1).reduce(function (a, d, k) {
            if (!1 !== d && "" !== d) {
              ...
              var A = k.series;
              var D =
                "highcharts-color-" + z(k.colorIndex, A.colorIndex, "none");
              u ||
                ((u = { padding: F.padding, r: F.borderRadius }),
                y ||
                  ((u.fill = F.backgroundColor),
                  (u["stroke-width"] = F.borderWidth)),
                (u = W.label(
                  "",
                  0,
                  0,
                  F[p ? "headerShape" : "shape"],
                  void 0,
                  void 0,
                  F.useHTML
                )
              ...
              if (k.isHeader) {
                ...
                u.shouldShowTooltip(0, l.pos - n + D, { ignoreX: !0 }) &&
                  (r = l.pos + D);
              }
              A = t(A, N.left - v, N.right + v);
              "number" === typeof r
                ? ((p = p.height + 1),
                  (D = T ? T.call(b, d, p, k) : c(A, r, e, d)),
                  a.push({
                    align: T ? 0 : void 0,
                    anchorX: A,
                    anchorY: r,
          ...
          !T &&
            a.some(function (a) {
              ...
              return c < N.left && c + a.boxWidth < N.right
                ? !0
                : c < Q - N.left + a.boxWidth && N.right - c > c;
            }) &&
            (a = a.map(function (a) {
              var b = c(a.anchorX, a.anchorY, a.point.isHeader, a.boxWidth, !1);
              return p(a, { target: b.y, x: b.x });
            }));
          b.cleanSplit();
          B(a, E);
          var C = Q,
          ...
          a.forEach(function (a) {
            ...
            a = a.isHeader;
            a ||
              (b.outside && Q + c < C && (C = Q + c),
              !a && b.outside && C + g > P && (P = Q + c));
          });
          a.forEach(function (a) {
            var c = a.x,
              g = a.anchorX,
            ...
            if (b.outside && c < g) {
              var e = Q - C;
              0 < e &&
                (k || ((d.x = c + e), (d.anchorX = g + e)),
                k && ((d.x = (P - C) / 2), (d.anchorX = g + e)));
            }
            a.tt.attr(d);
          });
          a = b.container;
          ...
          b.outside &&
            ...
            q &&
            ((k = V.getBBox()),
            q.setSize(k.width + k.x, k.height + k.y, !1),
            (a.style.left = C + "px"),
            (a.style.top = d + "px"));
        };
        ...
        k.prototype.tooltipFooterHeaderFormatter = function (a, b) {
          ...
          q(this, "headerFormatter", d, function (b) {
            k &&
              !e &&
              n(a.key) &&
              (e = k.getXDateFormat(a.key, g.dateTimeLabelFormats));
            k &&
              e &&
            ...
            b.text = E(m, { point: a, series: c }, this.chart);
          });
          return d.text;
        };
        ...
        k.prototype.updatePosition = function (a) {
          ...
          var e = (c.positioner || this.getPosition).call(
              this,
              k.width,
              k.height,
              a
    ...
    function (f, e, l, C, v) {
      ...
      e = (function () {
        ...
        g.prototype.applyOptions = function (a, b) {
          ...
          this.formatPrefix = (this.isNull = x(
        ...
        g.prototype.destroy = function () {
          ...
          g && g.enabled
            ? (this.animateBeforeDestroy(), m(a, f.duration))
            : a();
          d.pointCount--;
        };
        ...
        g.prototype.getNestedProperty = function (a) {
          if (a)
            return 0 === a.indexOf("custom.") ? p(a, this.options) : this[a];
        };
        g.prototype.getZone = function () {
          ...
          this.color =
            g && g.color && !this.options.color ? g.color : this.nonZonedColor;
          return g;
        };
        ...
        g.prototype.optionsToObject = function (a) {
          ...
          if (n(a) || null === a) e[d[0]] = a;
            ...
            for (
              ...
              a.length > k &&
              ((c = typeof a[0]),
              "string" === c ? (e.name = a[0]) : "number" === c && (e.x = a[0]),
              m++);
              f < k;

            )
              (b && "undefined" === typeof a[m]) ||
                (0 < d[f].indexOf(".")
                  ? g.prototype.setNestedProperty(e, a[m], d[f])
                  : (e[d[f]] = a[m])),
                m++,
                f++;
          else
        ...
        g.prototype.update = function (a, b, g, d) {
          function c() {
            ...
            h.data[p] =
              J(h.data[p], !0) || J(a, !0) ? k.options : x(a, h.data[p]);
          ...
          var k = this,
            ...
            p;
          b = x(b, !0);
          !1 === d ? c() : k.firePointEvent("update", { options: a }, c);
        };
        ...
        g.prototype.select = function (a, b) {
          ...
          c.firePointEvent(
            ...
            function () {
              ...
              c.setState(a && "select");
              b ||
                d.getSelectedPoints().forEach(function (a) {
                  var b = a.series;
                  a.selected &&
                    a !== c &&
                    ...
                    a.setState(
                      d.hoverPoints && b.options.inactiveOtherPoints
                        ? "inactive"
                        : ""
                    ),
        ...
        g.prototype.onMouseOver = function (a) {
          ...
          a = a
            ? b.normalize(a)
            : b.getChartCoordinatesFromPoint(this, c.inverted);
              ...
              if (!l.styledMode) {
                ...
                c.options.inactiveOtherPoints &&
                  ...
                  ((this.dataLabels || []).forEach(function (a) {
                    a && a.animate({ opacity: y.opacity }, F);
                  }),
                  this.connector &&
                    this.connector.animate({ opacity: y.opacity }, F));
                this.graphic.animate(y, F);
              }
              z &&
                this.graphic.animate(
                  z,
                  x(l.options.chart.animation, p.animation, m.animation)
                );
              w && w.hide();
            } else {
              if (a && p) {
                ...
                if (z)
                  if (w) w[g ? "animate" : "attr"]({ x: z.x, y: z.y });
                  else
                    k &&
                ...
                !l.styledMode &&
                  w &&
                  "inactive" !== this.state &&
                  w.attr(c.pointAttribs(this, a));
              }
              w &&
                (w[a && this.isInside ? "show" : "hide"](),
                (w.element.point = this),
                w.addClass(this.getClassName(), !0));
            }
            e = e.halo;
            z = ((w = this.graphic || w) && w.visibility) || "inherit";
            e && e.size && w && "hidden" !== z && !this.isCluster
              ? (t || (c.halo = t = l.renderer.path().add(w.parentGroup)),
                t.show()[g ? "animate" : "attr"]({ d: this.haloPath(e.size) }),
                t.attr({
                  class:
                    "highcharts-halo highcharts-color-" +
                    x(this.colorIndex, c.colorIndex) +
                ...
                l.styledMode ||
                  t.attr(
                    d(
                      ...
                      f.filterUserAttributes(e.attributes || {})
                    )
                  ))
              : t &&
                t.point &&
    ...
    function (f, e, l, C) {
      ...
      f = (function () {
          ...
          if (!w || !w.touch)
            if (
              ...
              (this.hasDragged = Math.sqrt(
                Math.pow(p - t, 2) + Math.pow(n - z, 2)
              )),
              10 < this.hasDragged)
            ) {
              var x = d.isInsidePlot(p - e, n - m, { visiblePlotOnly: !0 });
              (!d.hasCartesianSeries && !d.mapView) ||
                (!this.zoomX && !this.zoomY) ||
                !x ||
                l ||
                w ||
                ((this.selectionMarker = w =
                  d.renderer
                    .rect(e, m, g ? 1 : f, c ? 1 : h, 0)
              ...
              w &&
                g &&
                ((g = t - p),
                w.attr({ width: Math.abs(g), x: (0 < g ? 0 : g) + p }));
              w &&
                c &&
                ((g = z - n),
                w.attr({ height: Math.abs(g), y: (0 < g ? 0 : g) + n }));
        ...
        f.prototype.drop = function (b) {
            ...
            if (this.hasDragged || g)
              a.axes.forEach(function (a) {
                if (
                  a.zoomEnabled &&
                  h(a.min) &&
                  (g || k[{ xAxis: "zoomX", yAxis: "zoomY" }[a.coll]]) &&
                  q(e) &&
                  q(m)
                ) {
                  var c = a.horiz,
                ...
                l &&
                  p(a, "selection", r, function (c) {
                    a.zoom(d(c, g ? { animation: !1 } : null));
                  });
            q(a.index) &&
          ...
          a &&
            q(a.index) &&
            (t(a.container, { cursor: a._cursor }),
            ...
            if ((b = r(c, !0) && c.series) && !(b = !r(k, !0))) {
              ...
              var g = k.dist - c.dist,
                e =
                  ...
                  (k.series.group && k.series.group.zIndex);
              b =
                0 <
                (0 !== b && d
                  ? b
        ...
        f.prototype.getChartCoordinatesFromPoint = function (b, d) {
          ...
          if (g && a) {
            ...
            return d
              ? { chartX: a.len + a.pos - e, chartY: g.len + g.pos - k }
              : { chartX: k + g.pos, chartY: e + a.pos };
          }
        ...
        f.prototype.getChartPosition = function () {
          ...
          2 < a &&
            ...
            (this.chartPosition.scaleY = d.height / b));
            ...
            (c && !k.noSharedTooltip
              ? ((h = a.filter(function (a) {
                ...
                h.forEach(function (a) {
                  ...
                  r(c) &&
                    (a.chart.isBoosting && (c = a.getPoint(c)), f.push(c));
                }))
              : f.push(n));
          m = { hoverPoint: n };
          p(this, "afterGetHoverData", m);
          return { hoverPoint: m.hoverPoint, hoverSeries: k, hoverPoints: f };
        };
        ...
        f.prototype.onTrackerMouseOut = function (b) {
          ...
          if (
            !(
              ...
              !b ||
              d.stickyTracking ||
              this.inClass(b, "highcharts-tooltip") ||
              (this.inClass(b, "highcharts-series-" + d.index) &&
                this.inClass(b, "highcharts-tracker"))
            )
          )
            d.onMouseOut();
        };
        ...
        f.prototype.normalize = function (b, e) {
          var a = b.touches,
            g = a
              ? a.length
                ? a.item(0)
                : w(a.changedTouches, b.changedTouches)[0]
              : b;
          ...
          a /= e.scaleX;
          g /= e.scaleY;
          return d(b, { chartX: Math.round(a), chartY: Math.round(g) });
        };
        f.prototype.onContainerClick = function (b) {
          ...
          var g = e.plotLeft,
            c = e.plotTop;
          e.cancelClick ||
            (a && this.inClass(b.target, "highcharts-tracker")
              ? (p(a.series, "click", d(b, { point: a })),
                e.hoverPoint && a.firePointEvent("click", b))
              : (d(b, this.getCoordinates(b)),
                e.isInsidePlot(b.chartX - g, b.chartY - c, {
                  visiblePlotOnly: !0,
                }) && p(e, "click", b)));
        };
        f.prototype.onContainerMouseDown = function (b) {
          ...
          if ("undefined" === typeof b.button || d)
            this.zoomOption(b),
              d && b.preventDefault && b.preventDefault(),
              this.dragStart(b);
        };
        f.prototype.onContainerMouseLeave = function (b) {
          ...
          (a &&
            a.shouldStickOnContact() &&
            this.inClass(b.relatedTarget, "highcharts-tooltip-container")) ||
            ((b = this.normalize(b)),
            d &&
        ...
        f.prototype.onContainerMouseMove = function (b) {
          ...
          ("mousedown" === d.mouseIsDown || this.touchSelect(b)) &&
            this.drag(b);
          d.openMenu ||
            ...
            (this.inClass(b.target, "highcharts-no-tooltip")
              ? this.reset(!1, 0)
        ...
        f.prototype.pinch = function (b) {
          var e = this,
            ...
            r =
              1 === f &&
              ((e.inClass(b.target, "highcharts-tracker") &&
                a.runTrackerClick) ||
                e.runChartClick),
            q = {},
            l = e.selectionMarker;
          ...
          "touchstart" === b.type
              ...
              a.axes.forEach(function (c) {
                if (c.zoomEnabled) {
                  var b = a.bounds[c.horiz ? "h" : "v"],
                    d = c.minPixelPadding,
                    g = c.toPixels(
                      Math.min(w(c.options.min, c.dataMin), c.dataMin)
                    ),
                    e = c.toPixels(
                      Math.max(w(c.options.max, c.dataMax), c.dataMax)
                    ),
                    k = Math.max(g, e);
            ...
            ? this.runPointActions(e.normalize(b))
            : g.length &&
              (p(a, "touchpan", { originalEvent: b }, function () {
                l ||
                  (e.selectionMarker = l =
                    d({ destroy: G, touch: !0 }, a.plotBox));
        ...
        f.prototype.pinchTranslateDirection = function (
          b,
          d,
          a,
          g,
        ...
        f.prototype.runPointActions = function (d, e) {
          ...
          if (k && (k !== a.hoverPoint || (g && g.isHidden))) {
            ...
            e &&
              ...
              !g.isHidden &&
              ((c = g.getAnchor([{}], d)),
              a.isInsidePlot(c[0], c[1], { visiblePlotOnly: !0 }) &&
                g.updatePosition({ plotX: c[0], plotY: c[1] }));
          this.unDocMouseMove ||
          ...
          a.axes.forEach(function (c) {
            var g = w((c.crosshair || {}).snap, !0),
              e;
            g &&
              (((e = a.hoverPoint) && e.series[c.coll] === c) ||
                (e = b(m, function (a) {
        ...
        f.prototype.scaleGroups = function (b, d) {
          ...
          a.series.forEach(function (g) {
            ...
            g.group &&
              ((g.xAxis && g.xAxis.zoomEnabled) || a.mapView) &&
              (g.group.attr(c),
              g.markerGroup &&
                (g.markerGroup.attr(c),
                g.markerGroup.clip(d ? a.clipRect : null)),
              g.dataLabelsGroup && g.dataLabelsGroup.attr(c));
          });
        ...
        f.prototype.setDOMEvents = function () {
          ...
          this.eventsToUnbind.push(
            B(d, "mouseenter", this.onContainerMouseEnter.bind(this))
          );
          this.eventsToUnbind.push(
            B(d, "mouseleave", this.onContainerMouseLeave.bind(this))
          );
          f.unbindDocumentMouseUp ||
            (f.unbindDocumentMouseUp = B(
              a,
              "mouseup",
          ...
          e.hasTouch &&
            (this.eventsToUnbind.push(
              B(d, "touchstart", this.onContainerTouchStart.bind(this), {
                passive: !1,
              })
            ),
            this.eventsToUnbind.push(
              B(d, "touchmove", this.onContainerTouchMove.bind(this), {
                passive: !1,
              })
            ),
            f.unbindDocumentTouchEnd ||
              (f.unbindDocumentTouchEnd = B(
                a,
                "touchend",
        ...
        f.prototype.setHoverChartIndex = function () {
          ...
          if (d && d !== b)
            d.pointer.onContainerMouseLeave({ relatedTarget: b.container });
        ...
        f.prototype.touch = function (b, d) {
          ...
          if (1 === b.touches.length)
            if (
              ((b = this.normalize(b)),
              (g = a.isInsidePlot(b.chartX - a.plotLeft, b.chartY - a.plotTop, {
                visiblePlotOnly: !0,
              })) && !a.openMenu)
            ) {
              ...
              if ("touchmove" === b.type) {
                ...
                var c = d[0]
                  ? 4 <=
                    Math.sqrt(
                      Math.pow(d[0].chartX - b.chartX, 2) +
                        Math.pow(d[0].chartY - b.chartY, 2)
                    )
                  : !1;
              }
              w(c, !0) && this.pinch(b);
  ...
  K(
    l,
    "Core/MSPointer.js",
    [l["Core/Globals.js"], l["Core/Pointer.js"], l["Core/Utilities.js"]],
    function (f, e, l) {
      function C() {
        var d = [];
        d.item = function (b) {
      ...
      return (function (b) {
        ...
        e.prototype.onContainerPointerMove = function (b) {
          v(b, "onContainerTouchMove", "touchmove", function (b) {
            q[b.pointerId] = { pageX: b.pageX, pageY: b.pageY };
  ...
  K(
    ...
    function (f, e, l, C, v, E) {
      ...
      E = (function () {
        ...
        g.prototype.colorizeItem = function (a, b) {
          ...
          if (!this.chart.styledMode) {
            ...
            e &&
              (h &&
                e.isMarker &&
                ((m = a.pointAttribs()), b || (m.stroke = m.fill = f)),
              e.attr(m));
          }
        ...
        g.prototype.renderItem = function (a) {
          ...
          F ||
            ...
            (a.legendItem = F =
              b.text("", m ? g + e : -e, this.baseline || 0, q)),
            c.styledMode || F.css(z(a.visible ? f : k)),
            F.attr({ align: m ? "left" : "right", zIndex: 2 }).add(
              a.legendGroup
            ),
            this.baseline ||
              ((this.fontMetrics = b.fontMetrics(
              ...
              d.squareSymbol &&
                ...
                (l = this.symbolWidth + e + h + (r ? 20 : 0)),
                m && F.attr("x", this.symbolWidth + e))),
            n.drawLegendSymbol(this, a),
            this.setItemEvents && this.setItemEvents(a, F, q));
          r &&
            !a.checkbox &&
          ...
          a.itemWidth = a.checkboxOffset =
            d.itemWidth || a.legendItemWidth || c.width + l;
          this.maxItemWidth = Math.max(this.maxItemWidth, a.itemWidth);
          this.totalItemWidth += a.itemWidth;
          this.itemHeight = a.itemHeight = Math.round(
            a.legendItemHeight || (c.height > 1.5 * b ? c.height : b)
          );
        };
        g.prototype.layoutItem = function (a) {
          ...
          d &&
            this.itemX - b + c > h &&
            ((this.itemX = b),
            this.lastLineHeight && (this.itemY += f + this.lastLineHeight + e),
          ...
          d
            ? (this.itemX += c)
            : ((this.itemY += f + g + e), (this.lastLineHeight = g));
          this.offsetWidth =
            this.widthOption ||
            Math.max(
              (d ? this.itemX - b - (a.checkbox ? 0 : k) : c) + b,
              this.offsetWidth
            );
        };
        g.prototype.getAllItems = function () {
          ...
          this.chart.series.forEach(function (c) {
            var b = c && c.options;
            c &&
              x(b.showInLegend, q(b.linkedTo) ? !1 : void 0, !0) &&
              (a = a.concat(
        ...
        g.prototype.proximatePositions = function () {
          ...
          this.allItems.forEach(function (c) {
            ...
            if (c.yAxis) {
              ...
              e =
                this.itemMarginTop +
                c.legendItem.getBBox().height +
                this.itemMarginBottom;
              var f = c.yAxis.top - a.plotTop;
              c.visible
                ? ((g = g ? g.plotY : c.yAxis.height), (g += f - 0.3 * e))
                : (g = f + c.yAxis.height);
              b.push({ target: g, size: e, item: c });
            }
          }, this);
          ...
          f ||
            ((this.group = f =
              b
                ...
                .attr({ zIndex: 7 })
                .add()),
            (this.contentGroup = b.g().attr({ zIndex: 1 }).add(f)),
        ...
        g.prototype.handleOverflow = function (a) {
          ...
          h && (e = Math.min(e, h));
          l.length = 0;
          a && 0 < e && a > e && !1 !== m.enabled
            ? ((this.clipHeight = F =
                Math.max(e - 20 - this.titleHeight - k, 0)),
        ...
        g.prototype.scroll = function (c, b) {
          ...
          0 < n &&
            ...
            (c = G(x(b, g.renderer.globalAnimation, !0))),
            a(function () {
              J(d, "afterScroll", { currentPage: n });
            }, c.duration));
        };
          ...
          var c = this,
            ...
            h = function (b) {
              c.allItems.forEach(function (c) {
                a !== c &&
                  [c].concat(c.linkedSeries || []).forEach(function (a) {
                    a.setState(b, !e);
                  });
              });
            };
      ...
      (/Trident\/7\.0/.test(l.navigator && l.navigator.userAgent) || f) &&
        v(E.prototype, "positionItem", function (a, c) {
          var b = this,
            d = function () {
      ...
      f = (function () {
        ...
        f.prototype.init = function (a, d) {
          ...
          O(this, "init", { args: arguments }, function () {
            ...
            this.series = [];
            this.time =
              a.time && Object.keys(a.time).length ? new b(a.time) : v.time;
        ...
        f.prototype.initSeries = function (a) {
          ...
          var b = A[c];
          b || H(17, !0, this, { missingModuleFor: c });
          c = new b();
        ...
        f.prototype.isInsidePlot = function (a, c, b) {
          ...
          if (!b.ignoreX) {
            var n = (p && (d ? p.yAxis : p.xAxis)) || { pos: e, len: Infinity };
            k = b.paneCoordinates ? n.pos + k : e + k;
            (k >= Math.max(h + e, n.pos) &&
              k <= Math.min(h + e + g.width, n.pos + n.len)) ||
              (a.isInsidePlot = !1);
          }
          !b.ignoreY &&
            a.isInsidePlot &&
            ((d = (p && (d ? p.xAxis : p.yAxis)) || { pos: f, len: Infinity }),
            (b = b.paneCoordinates ? d.pos + c : f + c),
            (b >= Math.max(m + f, d.pos) &&
              b <= Math.min(m + f + g.height, d.pos + d.len)) ||
              (a.isInsidePlot = !1));
        ...
        f.prototype.get = function (a) {
          ...
          for (
            var b = this.series,
              d = da(this.axes, c) || da(this.series, c),
              g = 0;
            !d && g < b.length;
            g++
          )
          ...
          if (a)
            for (; c && c.style; )
              c.hcOrigStyle && (M(c, c.hcOrigStyle), delete c.hcOrigStyle),
                c.hcOrigDetached &&
                  (m.body.removeChild(c), (c.hcOrigDetached = !1)),
                (c = c.parentNode);
          else
            for (; c && c.style; ) {
              m.body.contains(c) ||
                c.parentNode ||
                ((c.hcOrigDetached = !0), m.body.appendChild(c));
              if ("none" === ea(c, "display", !1) || c.hcOricDetached)
                (c.hcOrigStyle = {
        ...
        f.prototype.getContainer = function () {
          ...
          this.container = g = R("div", { id: g }, e, f);
          this._cursor = g.style.cursor;
          this.renderer = new (
            b.renderer || !a ? t.getRendererType(b.renderer) : d
          )(
            g,
            k,
            h,
        ...
        f.prototype.reflow = function (a) {
          ...
          if (!e && !c.isPrinting && f && b && (d === g || d === m)) {
            if (f !== c.containerWidth || b !== c.containerHeight)
        ...
        f.prototype.setReflow = function (a) {
          ...
          !1 === a || this.unbindReflow
            ...
            : ((this.unbindReflow = u(g, "resize", function (a) {
        ...
        f.prototype.setChartSize = function (a) {
          ...
          this.plotHeight = n = Math.max(
            0,
            Math.round(g - m - this.marginBottom)
          );
          ...
          this.plotBox = b.plotBox = { x: h, y: m, width: p, height: n };
          ...
          this.clipBox = {
            ...
            height: Math.max(
              0,
              Math.floor(this.plotSizeY - Math.max(c, k[2]) / 2 - g)
            ),
          };
          a ||
            ...
            b.alignElements());
          O(this, "afterSetChartSize", { skipAxes: a });
        };
        ...
        f.prototype.drawChartBox = function () {
          ...
          if (g) var x = (z = u.strokeWidth());
            ...
            f = { fill: f || "none" };
            if (x || u["stroke-width"])
              (f.stroke = a.borderColor), (f["stroke-width"] = x);
          ...
          t ||
            ((w = "attr"),
            (this.plotBackground = t =
              c.rect().addClass("highcharts-plot-background").add()));
          t[w](F);
          g ||
            (t.attr({ fill: k || "none" }).shadow(a.plotShadow),
            h &&
              (e
                ? (h !== e.attr("href") && e.attr("href", h), e.animate(F))
                : (this.plotBGImage = c.image(h, m, p, n, l).add())));
          r
          ...
          N[w](N.crisp({ x: m, y: p, width: n, height: l }, -N.strokeWidth()));
          this.isDirtyBox = !1;
        ...
        f.prototype.linkSeries = function () {
          ...
          c.forEach(function (c) {
            ...
            V(b) &&
              ...
              (c.visible = Q(c.options.visible, b.options.visible, c.visible)));
          });
        ...
        f.prototype.renderLabels = function () {
          ...
          c.items &&
            c.items.forEach(function (b) {
              ...
              delete d.left;
              delete d.top;
              a.renderer.text(b.html, g, e).attr({ zIndex: 2 }).css(d).add();
            });
        };
        f.prototype.render = function () {
          var a = this.axes,
        ...
        f.prototype.addSeries = function (a, c, b) {
          ...
          a &&
            ((c = Q(c, !0)),
            O(d, "addSeries", { options: a }, function () {
              g = d.initSeries(a);
              d.isDirtyLegend = !0;
              d.linkSeries();
              g.enabledDataSorting && g.setData(a.data, !1);
              O(d, "afterAddSeries", { series: g });
              c && d.redraw(b);
            }));
          return g;
        };
        ...
        f.prototype.createAxis = function (a, c) {
          a = new e(
            this,
            W(c.axis, { index: this[a].length, isX: "xAxis" === a })
          );
        ...
        f.prototype.showLoading = function (a) {
          ...
          c.styledMode ||
            (M(e, K(d.style, { zIndex: 10 })),
            M(f, d.labelStyle),
            c.loadingShown ||
              (M(e, { opacity: 0, display: "" }),
              r(
                e,
        ...
        f.prototype.update = function (a, c, d, g) {
          ...
          a.time &&
            (this.time === D && (this.time = new b(a.time)),
            W(!0, e.options.time, a.time));
          X(a, function (c, b) {
            if (e[b] && "function" === typeof e[b].update) e[b].update(c, !1);
              ...
              "colors" !== b &&
                ...
                W(!0, e.options[b], a[b]);
            "chart" !== b &&
              -1 !== e.propsRequireUpdateSeries.indexOf(b) &&
              (m = !0);
          });
          ...
          p || (T(l) && l !== e.chartWidth) || (T(n) && n !== e.chartHeight)
            ? e.setSize(l, n, g)
            : Q(c, !0) && e.redraw(g);
          O(e, "afterUpdate", { options: a, redraw: c, animation: g });
        };
        ...
        f.prototype.showResetZoom = function () {
          ...
          O(this, "beforeShowResetZoom", null, function () {
            b.resetZoomButton = b.renderer
              .button(d.resetZoom, null, null, a, e)
              .attr({ align: g.position.align, title: d.resetZoomTitle })
              .addClass("highcharts-reset-zoom")
              .add()
              .align(g.position, !1, f);
          });
        ...
        f.prototype.zoom = function (a) {
          ...
          !a || a.resetSelection
            ...
            : a.xAxis.concat(a.yAxis).forEach(function (a) {
                ...
                b[m ? "zoomX" : "zoomY"] &&
                  n &&
                  ((e = f.zoom(a.min, a.max)), f.displayBtn && (g = !0));
              });
          var f = c.resetZoomButton;
          g && !f
            ? c.showResetZoom()
            : !g && N(f) && (c.resetZoomButton = f.destroy());
          e &&
            c.redraw(
            ...
            c.forEach(function (c) {
              if (c.options.panningEnabled && !c.options.isInternal) {
                ...
                var h = b[d],
                  ...
                  F =
                    c.toValue(h + c.len - k, !0) -
                    (m * n || (c.isXAxis && c.pointRangePadding) || 0),
                  r = F < l;
                ...
                !n ||
                  ...
                  c.series.forEach(function (a) {
                    ...
                    T(c.dataMin) &&
                      T(c.dataMax) &&
                      ((q.startMin = Math.min(
                        Q(a.options.threshold, Infinity),
                        c.dataMin,
                        q.startMin
                      )),
                      (q.startMax = Math.max(
                ...
                n = Math.min(
                  Q(q && q.startMin, p.dataMin),
                  m ? p.min : c.toValue(c.toPixels(p.min) - c.minPixelPadding)
                );
                F = Math.max(
                  Q(q && q.startMax, p.dataMax),
                  m ? p.max : c.toValue(c.toPixels(p.max) + c.minPixelPadding)
                );
                c.panningState = q;
                c.isOrdinal ||
                  ((m = n - h),
                  ...
                  c.series.length &&
                    ...
                    h >= n &&
                    l <= F &&
                    (c.setExtremes(h, l, !1, !1, { trigger: "pan" }),
                    !b.resetZoomButton &&
                      h !== n &&
                      l !== F &&
                      e.match("y") &&
    ...
    (function (f) {
      f.drawLineMarker = function (f) {
        ...
        p &&
          !1 !== p.enabled &&
          B &&
          ((v = Math.min(l(p.radius, t), t)),
          0 === this.symbol.indexOf("url") &&
            ((p = e(p, { width: y, height: y })), (v = 0)),
          (this.legendSymbol = B =
            h
              .symbol(this.symbol, B / 2 - v, f - v, 2 * v, 2 * v, p)
      ...
      f.drawRectangle = function (e, f) {
        ...
        f.legendSymbol = this.chart.renderer
          .rect(
            y ? (e.symbolWidth - v) / 2 : 0,
            e.baseline - v + 1,
            y ? v : e.symbolWidth,
            v,
            l(e.options.symbolRadius, v / 2)
          )
          .addClass("highcharts-point")
          .attr({ zIndex: 3 })
          .add(f.legendGroup);
      ...
      f = (function () {
          ...
          L(this, "bindAxes", null, function () {
            (a.axisTypes || []).forEach(function (g) {
              ...
              b[g].forEach(function (b) {
                ...
                if (
                  (c[g] === e && !d.isInternal) ||
                  ("undefined" !== typeof c[g] && c[g] === d.id) ||
                  ("undefined" === typeof c[g] && 0 === d.index)
                )
                  a.insert(b.series), (a[g] = b), (b.isDirty = !0);
                d.isInternal || e++;
              });
        ...
        e.prototype.autoIncrement = function (a) {
          ...
          b &&
            ((c = new g.Date(e)),
            "day" === b
              ? g.set("Date", c, g.get("Date", c) + f)
              : "month" === b
              ? g.set("Month", c, g.get("Month", c) + f)
              : "year" === b && g.set("FullYear", c, g.get("FullYear", c) + f),
            (f = c.getTime() - e));
          if (d && M(a)) return e + f;
          this.xIncrement = e + f;
          return e;
        ...
        e.prototype.setOptions = function (a) {
          ...
          this.tooltipOptions = P(
            b.tooltip,
            b.plotOptions.series && b.plotOptions.series.tooltip,
            b.plotOptions[this.type].tooltip,
        ...
        e.prototype.getColor = function () {
          this.chart.styledMode
            ...
            : this.getCyclic(
                "color",
                this.options.color || b.plotOptions[this.type].color,
        ...
        e.prototype.updateData = function (a, c) {
              ...
              if (
                ...
                -1 === n || "undefined" === typeof n
                  ...
                  ? (e[n].update(a, !1, null, !1),
                    ...
                    k && (p = n + 1))
                  : e[n] && (e[n].touched = !0),
                !h || c !== n || (d && d.enabled) || this.hasDerivedData)
              )
                m = !0;
            } else f.push(a);
          }, this);
          ...
          null === this.xIncrement &&
            this.xData &&
            this.xData.length &&
            ((this.xIncrement = z(this.xData)), this.autoIncrement());
          return !0;
        };
            ...
            if (p && x > p)
              ...
              for (b = 0; b < x; b++)
                "undefined" !== typeof a[b] &&
                  ((d = { series: g }),
                  g.pointClass.prototype.applyOptions.apply(d, [a[b]]),
                  g.updateParallelArrays(d, b));
            r && U(r[0]) && D(14, !0, h);
            g.data = [];
        ...
        e.prototype.getProcessedData = function (a) {
          ...
          for (d = k.length || 1; --d; )
            if (
              ((c = b ? a(k[d]) - a(k[d - 1]) : k[d] - k[d - 1]),
              0 < c && ("undefined" === typeof u || c < u))
            )
              var u = c;
        ...
        e.prototype.generatePoints = function () {
          ...
          for (p = 0; p < e; p++) {
            ...
            if (k) {
              ...
              q.dataGroup.options &&
                ...
                A(q, q.dataGroup.options),
                delete q.dataLabels);
            } else
              (q = l[r]) ||
                "undefined" === typeof c[r] ||
                (l[r] = q = new g().init(this, c[r], b[p]));
          ...
          if (l && (e !== (n = l.length) || k))
            for (p = 0; p < n; p++)
              p !== f || k || (p += e),
                l[p] && (l[p].destroyElements(), (l[p].plotX = void 0));
          this.data = l;
          this.points = m;
        ...
        e.prototype.getExtremes = function (a, c) {
          ...
          for (k = 0; k < p; k++) {
            ...
            q =
              ...
              ((g[k + f] || q) >= h && (g[k - f] || q) <= m);
            if (r && q)
              if ((r = l.length)) for (; r--; ) M(l[r]) && (e[n++] = l[r]);
              else e[n++] = l;
          }
          a = { activeYData: e, dataMin: x(e), dataMax: z(e) };
          ...
          for (t = 0; t < n; t++) {
            var x = h[t],
              ...
              B =
                ...
                k.stacking &&
                k.stacking.stacks[
                  (this.negStacks && v < (r ? 0 : q) ? "-" : "") + this.stackKey
                ];
            if (
              (k.positiveValuesOnly && !k.validatePositiveValue(v)) ||
              (d.positiveValuesOnly && !d.validatePositiveValue(A))
            )
              x.isNull = !0;
            x.plotX = z = a(
              m(d.translate(A, 0, 0, 0, 1, p, "flags" === this.type), -1e5, 1e5)
            );
            ...
            R(D) &&
              ((J = D[0]),
              (v = D[1]),
              J === r && C.key === B[A].base && (J = H(M(q) && q, k.min)),
              k.positiveValuesOnly && 0 >= J && (J = null),
              (x.total = x.stackTotal = y.total),
              (x.percentage = y.total && (x.y / y.total) * 100),
              (x.stackY = v),
            ...
            x.plotY = void 0;
            M(v) &&
              ((y = k.translate(v, !1, !0, !1, !0)),
              "undefined" !== typeof y && (x.plotY = m(y, -1e5, 1e5)));
          ...
          if (a && b)
            (e = this.getClipBox()),
              k
                ...
                : ((e.width = 0),
                  g && (e.x = c.plotHeight),
                  (k = c.renderer.clipRect(e)),
                  (c.sharedClips[f] = k),
                  (m = c.renderer.clipRect({
            ...
            d &&
              ...
              (e.step = function (a, c) {
                ...
                m &&
                  m.element &&
                  m.attr(c.prop, "width" === c.prop ? a + 99 : a);
              });
        ...
        e.prototype.drawPoints = function () {
          ...
          if (!1 !== b.enabled || this._hasPointMarkers)
            for (f = 0; f < a.length; f++) {
              ...
              var p = !!h.marker;
              if (
                ((e && "undefined" === typeof n.enabled) || n.enabled) &&
                !h.isNull &&
                !1 !== h.visible
              ) {
                ...
                this.enabledDataSorting &&
                  (h.startXPos = g.reversed ? -(q.width || 0) : g.width);
                var r = !1 !== h.isInside;
                k
                  ? k[r ? "show" : "hide"](r).animate(q)
                  : r &&
                    (0 < (q.width || 0) || h.hasImage) &&
                    ((h.graphic = k =
                      c.renderer
                        .symbol(l, q.x, q.y, q.width, q.height, p ? n : b)
                        .add(d)),
                    this.enabledDataSorting &&
                      c.hasRendered &&
                      (k.attr({ x: h.startXPos }), (m = "animate")));
                k && "animate" === m && k[r ? "show" : "hide"](r).animate(q);
                if (k && !c.styledMode)
                  k[m](this.pointAttribs(h, h.selected && "select"));
        ...
        e.prototype.pointAttribs = function (a, c) {
          ...
          a = H(
            c.lineWidth,
            b.lineWidth,
            a + H(c.lineWidthPlus, b.lineWidthPlus, 0)
          );
          e = c.fillColor || b.fillColor || e;
          f = c.lineColor || b.lineColor || f;
          d = H(c.opacity, b.opacity, d);
          return { stroke: f, "stroke-width": a, fill: e, opacity: d };
        };
        e.prototype.destroy = function (a) {
          ...
          (b.axisTypes || []).forEach(function (a) {
            (m = b[a]) &&
              m.series &&
              (c(m.series, b), (m.isDirty = m.forceRedraw = !0));
          });
            ...
            d.forEach(function (d, F) {
              ...
              h.isXAxis
                ? ((q = {
                  ...
                  y || (q.x = c.plotHeight - q.x))
                : ((q = { x: 0, y: n ? t : u, width: k, height: r }),
                  y && (q.y = c.plotWidth - q.y));
              n &&
                b.isVML &&
                (q = h.isXAxis
                  ? { x: 0, y: A ? u : t, height: q.width, width: c.chartWidth }
                  : {
        ...
        e.prototype.invertGroups = function (a) {
          ...
          var b = this,
            d = b.chart;
          b.xAxis &&
            (b.eventsToUnbind.push(w(d, "resize", c)),
            c(),
            (b.invertGroups = c));
        };
        ...
        e.prototype.drawTracker = function () {
          var a = this,
            ...
            n = "rgba(192,192,192," + (r ? 0.0001 : 0.002) + ")";
          h
            ? h.attr({ d: d })
            : a.graph &&
              ((a.tracker = f
        ...
        e.prototype.addPoint = function (a, c, b, d, g) {
          ...
          b &&
            (f[0] && f[0].remove
              ? f[0].remove(!1)
              : (f.shift(), this.updateParallelArrays(l, "shift"), m.shift()));
          !1 !== g && L(this, "addPoint", { point: l });
        ...
        e.prototype.removePoint = function (a, c, b) {
          var g = this,
            ...
            m = function () {
              ...
              g.updateParallelArrays(f || { series: g }, "splice", a, 1);
              f && f.destroy();
              g.isDirty = !0;
              g.isDirtyData = !0;
              c && h.redraw();
        ...
        e.prototype.update = function (a, c) {
          ...
          var b = this,
            ...
            h = J[e].prototype,
            m = b.finishedAnimating && { animation: !1 },
            n = {},
            p,
          ...
          r &&
            ...
            !1 !== a.visible && l.push("area", "graph"),
            b.parallelArrays.forEach(function (a) {
              l.push(a + "Data");
            }),
            a.data &&
              (a.dataSorting && A(b.options.dataSorting, a.dataSorting),
          ...
          if (J[q]) {
            if (((f = q !== b.type), b.remove(!1, !1, !1, !0), f))
              if (Object.setPrototypeOf)
                Object.setPrototypeOf(b, J[q].prototype);
              else {
        ...
        e.prototype.setState = function (a, c) {
          ...
          if (
            ...
            if (g && !g.dashstyle)
              for (
                d = { "stroke-width": h }, g.animate(d, k);
                b["zone-graph-" + m];
  ...
  K(
    ...
    function (f, e, l, C, v, E) {
        ...
        if (!this.renderer.forExport) {
          if (f) {
            if (
              ...
              var l = { 1: { name: "right", value: f } };
            }
          } else
            d &&
              ((this.scrollablePixelsY = f = Math.max(0, d - this.chartHeight)),
              t(f) &&
      ...
      l.prototype.setUpScrolling = function () {
        ...
        this.scrollingParent = y(
          "div",
          { className: "highcharts-scrolling-parent" },
          { position: "relative" },
          this.renderTo
        );
        this.scrollingContainer = y(
          "div",
      ...
      l.prototype.applyFixed = function () {
        ...
        this.chartBackground.attr({ width: e, height: h });
    ...
    function (f, e, l) {
      ...
      (function (e) {
        ...
        e.compose = function (e) {
          -1 === f.indexOf(e) &&
            (f.push(e), v(e, "init", b), v(e, "destroy", d));
          return e;
        };
        var h = (function () {
          function b(b) {
          ...
          b.prototype.resetStacks = function () {
            ...
            b.axis.isXAxis ||
              y(d, function (d) {
                y(d, function (e, f) {
                  B(e.touched) && e.touched < b.stacksTouched
    ...
    function (f, e, l, C, v, E, G) {
        ...
        r = (function () {
          ...
          d.prototype.setOffset = function (d, e, f, h, m) {
            var k = this.axis,
              a = k.chart;
            h = k.translate(
              k.stacking.usePercentage ? 100 : h ? h : this.total,
              0,
              0,
              0,
              1
            ...
            e &&
              ...
              (g =
                "left" === g
                  ...
                  ? f
                    ...
                    : -h
                  : m.width / 2),
              (f = a.inverted ? m.height / 2 : f ? -h : m.height),
              (this.alignOptions.x = q(this.options.x, 0)),
              (this.alignOptions.y = q(this.options.y, 0)),
              (k.x -= g),
              (k.y -= f),
              ...
              q(!d && this.options.crop, !0) &&
                ((a =
                  b(e.x) &&
                  b(e.y) &&
                  a.isInsidePlot(e.x - h + e.width, e.y) &&
                  a.isInsidePlot(e.x + h, e.y)) ||
                  e.hide()));
          };
          d.prototype.getStackBox = function (b, d, e, f, h, k, a) {
            ...
            return {
              x: c
                ? d
                  ? f - a.right
                  : f - k + a.pos - b.plotLeft
                : e + b.xAxis[0].transB - b.plotLeft,
      ...
      e.prototype.getStacks = function () {
        ...
        b.series.forEach(function (e) {
          ...
          !e.options.stacking ||
            (!0 !== e.visible && !1 !== b.options.chart.ignoreHiddenSeries) ||
            (e.stackKey = [
              e.type,
              q(e.options.stack, ""),
              d ? f.top : f.left,
      ...
      v.prototype.setStackedPoints = function (b) {
        ...
        if (
          ...
          for (C = 0; C < m; C++) {
            ...
            u[H][M] ||
              (v[H] && v[H][M]
                ? ((u[H][M] = v[H][M]), (u[H][M].total = null))
                : (u[H][M] = new r(l, l.options.stackLabels, B, M, k)));
            H = u[H][M];
            null !== G
              ? ((H.points[I] = H.points[this.index] = [q(H.cumulative, g)]),
                t(H.cumulative) || (H.base = I),
                (H.touched = l.stacking.stacksTouched),
                0 < E.index &&
                  !1 === this.singleStacks &&
                  (H.points[I][0] = H.points[this.index + "," + M + ",0"][0]))
              : (H.points[I] = H.points[this.index] = null);
            "percent" === e
              ? ((B = B ? b : c),
                p && u[B] && u[B][M]
                  ? ((B = u[B][M]),
                    (H.total = B.total =
                      Math.max(B.total, H.total) + Math.abs(G) || 0))
                  : (H.total = y(H.total + (Math.abs(G) || 0))))
              : "group" === e
              ? (d(G) && (G = G[0]),
                null !== G && (H.total = (H.total || 0) + 1))
              : (H.total = y(H.total + (G || 0)));
            H.cumulative =
              "group" === e
                ? (H.total || 1) - 1
                : q(H.cumulative, g) + (G || 0);
            null !== G &&
              (H.points[I].push(H.cumulative),
              (n[C] = H.cumulative),
              (H.hasValidPoints = !0));
          }
        ...
        b[m + "Stacker"] &&
          [d, "-" + d].forEach(function (d) {
            for (var a = f.length, g, c; a--; )
              if (
                ((g = f[a]),
                (h = b.getStackIndicator(h, g, b.index, d)),
                (c = (g = e[d] && e[d][g]) && g.points[h.key]))
              )
                b[m + "Stacker"](c, g, a);
          });
      };
      ...
      v.prototype.getStackIndicator = function (b, d, e, f) {
        !t(b) || b.x !== d || (f && b.stackKey !== f)
          ? (b = { x: d, index: 0, key: f, stackKey: f })
          : b.index++;
        ...
        l.prototype.drawGraph = function () {
          ...
          b.forEach(function (b, l) {
            var p = b[0],
              ...
              q = n ? "animate" : "attr";
            n
              ? ((n.endX = e.preventGraphAnimation ? null : h.xMap),
                n.animate({ d: h }))
              : h.length &&
                (e[p] = n =
                  e.chart.renderer
      ...
      C = (function (e) {
        ...
        d.prototype.drawGraph = function () {
          ...
          this.zones.forEach(function (d, e) {
            h.push([
              "zone-area-" + e,
              "highcharts-area highcharts-zone-area-" + e + " " + d.className,
              d.color || b.color,
              d.fillColor || f.fillColor,
            ]);
          });
          h.forEach(function (e) {
            var h = e[0],
              ...
              l = n ? "animate" : "attr";
            n
              ? ((n.endX = b.preventGraphAnimation ? null : d.xMap),
                n.animate({ d: d }))
              : ((p.zIndex = 0),
                (n = b[h] =
                  b.chart.renderer.path(d).addClass(e[1]).add(b.group)),
                (n.isArea = !0));
            b.chart.styledMode ||
              (p.fill = t(
                e[3],
                E(e[2]).setOpacity(t(f.fillOpacity, 0.75)).get()
              ));
            n[l](p);
            n.startX = d.xMap;
        ...
        d.prototype.getGraphPath = function (b) {
          ...
          for (var g = 0, c = b.length; g < c; ++g) {
            ...
            if (!D || e)
              e || a(g, g - 1, "left"),
                (D && !f && e) ||
                  (w.push(b[g]), l.push({ x: g, plotX: A, plotY: u })),
                e || a(g, g + 1, "right");
          }
          a = d.call(this, w, !0, !0);
          l.reversed = !0;
        ...
        d.defaultOptions = B(G.defaultOptions, { threshold: 0 });
        return d;
      })(G);
      f(C.prototype, {
        singleStacks: !1,
      ...
      e = (function (e) {
        ...
        f.prototype.getPointSpline = function (e, f, h) {
          ...
          if (
            ...
            w += r;
            t > e && t > b
              ? ((t = Math.max(e, b)), (w = 2 * b - t))
              : t < e && t < b && ((t = Math.min(e, b)), (w = 2 * b - t));
            w > h && w > b
              ? ((w = Math.max(h, b)), (t = 2 * b - w))
              : w < h && w < b && ((w = Math.min(h, b)), (t = 2 * b - w));
            f.rightContX = l;
            f.rightContY = w;
          }
          f = [
  ...
  K(
    ...
    [
      l["Series/Spline/SplineSeries.js"],
      l["Core/Legend/LegendSymbol.js"],
      l["Core/Series/SeriesRegistry.js"],
      l["Core/Utilities.js"],
    ],
    ...
    function (f, e, l, C, v, E, G) {
      ...
      G = (function (e) {
        ...
        f.prototype.animate = function (a) {
          ...
          if (a)
            (k.scaleY = 0.001),
              (a = d(c.toPixels(e.threshold), c.pos, c.pos + c.len)),
              f ? (k.translateX = a - c.len) : (k.translateY = a),
              b.clipBox && b.setClip(),
              b.group.attr(k);
          else {
            ...
            b.group.animate(
              ...
              q(y(b.options.animation), {
                step: function (a, d) {
                  b.group &&
                    ((k[h] = m + d.pos * (c.pos - m)), b.group.attr(k));
                },
              })
            );
          }
        ...
        f.prototype.getColumnMetrics = function () {
          ...
          b = Math.min(
            ...
            z(b.pointWidth, p * (1 - 2 * b.pointPadding))
          );
          a.columnMetrics = {
            width: b,
            offset:
          ...
          a.points.forEach(function (e) {
            ...
            l &&
              ...
              J(h) &&
                ...
                (t !== x || (k.max || 0) <= h) &&
                (A = !A),
              (v = Math.abs(v - m) > l ? g - l : m - (A ? l : 0)));
            p(e.options.pointWidth) &&
              ((D = C = Math.ceil(e.options.pointWidth)),
              (B -= Math.round((D - q) / 2)));
            c.centerInCategory && (B = a.adjustForMissingColumns(B, D, e, n));
            e.barX = B;
            e.pointWidth = D;
            e.tooltipPos = b.inverted
              ? [
                  d(
                    k.len + k.pos - b.plotLeft - u,
                    k.pos - b.plotLeft,
                    k.len + k.pos - b.plotLeft
                  ),
                  f.len + f.pos - b.plotTop - B - C / 2,
                  y,
                ]
              : [
                  f.left - b.plotLeft + B + C / 2,
                  d(
                    u + k.pos - b.plotTop,
                    k.pos - b.plotTop,
        ...
        f.prototype.pointAttribs = function (a, b) {
          ...
          b &&
            ...
            (f =
              a.color ||
              ("undefined" !== typeof b && t(f).brighten(a.brightness).get()) ||
              f),
            (k = a[e] || k),
            (h = a[g] || h),
            (d = a.dashStyle || d),
            (m = z(a.opacity, m)));
          e = { fill: f, stroke: k, "stroke-width": h, opacity: m };
          d && (e.dashstyle = d);
          return e;
        };
        f.prototype.drawPoints = function () {
          ...
          a.points.forEach(function (g) {
            ...
            if (J(g.plotY) && null !== g.y) {
              ...
              a.enabledDataSorting &&
                (g.startXPos = a.xAxis.reversed
                  ? -(f ? f.width || 0 : 0)
                  : a.xAxis.width);
              k ||
                ((g.graphic = k = d[g.shapeType](f).add(g.group || a.group)) &&
                  a.enabledDataSorting &&
                  b.hasRendered &&
                  b.pointCount < e &&
                  (k.attr({ x: g.startXPos }), (h = !0), (m = "animate")));
              if (k && h) k[m](w(f));
              if (c.borderRadius) k[m]({ r: c.borderRadius });
              b.styledMode ||
                k[m](a.pointAttribs(g, g.selected && "select")).shadow(
                  !1 !== g.allowShadow && c.shadow,
                  null,
                  c.stacking && !c.borderRadius
                );
              k &&
                (k.addClass(g.getClassName(), !0),
                k.attr({ visibility: g.visible ? "inherit" : "hidden" }));
          ...
          a._hasTracking ||
            (a.trackerGroups.forEach(function (g) {
              if (a[g]) {
                ...
                !d.styledMode &&
                  a.options.cursor &&
                  a[g].css(b).css({ cursor: a.options.cursor });
              }
            }),
            (a._hasTracking = !0));
      ...
      (function (e) {
        function f(b, a, e, c, f) {
          var g = this,
            ...
            z =
              ...
              (b.series.forceDL ||
                (m && !x) ||
                r ||
                (d(e.inside, !!this.options.stacking) &&
                  c &&
                  k.isInsidePlot(l, h ? c.x + 1 : c.y + c.height - 1, {
                    inverted: h,
                    paneCoordinates: !0,
                    series: g,
                  })));
          if (z && E(l) && E(p)) {
            ...
            var v = k.renderer.fontMetrics(
              k.styledMode ? void 0 : e.style.fontSize,
              a
            ).b;
            c = G(
              {
            ...
            G(e, { width: q.width, height: q.height });
            n
              ? ((x = !1),
                (w = k.renderer.rotCorr(v, n)),
                (l = {
                ...
                (w = [q.x - Number(a.attr("x")), q.y - Number(a.attr("y"))]),
                t(l),
                a[f ? "attr" : "animate"](l))
              : (t(c), a.align(e, void 0, c), (l = a.alignAttr));
            x && 0 <= c.height
              ? this.justifyDataLabel(a, e, l, q, c, f)
              : d(e.crop, !0) &&
                ((c = l.x),
                (t = l.y),
                (c += w[0]),
                (t += w[1]),
                (z =
                  k.isInsidePlot(c, t, { paneCoordinates: !0, series: g }) &&
        ...
        function p() {
          var e = this,
            ...
            n,
            q = p.animation;
          q = p.defer ? C(a, q, e) : { defer: 0, duration: 0 };
          p = z(
            z(
              ...
              a.options.plotOptions &&
                a.options.plotOptions[e.type] &&
                a.options.plotOptions[e.type].dataLabels
            ),
            p
          );
          ...
          if (y(p) || p.enabled || e._hasPointLabels) {
            ...
            !f &&
              (f = e.dataLabelsGroup) &&
              (e.visible && r.show(),
              f[g.animation ? "animate" : "attr"]({ opacity: 1 }, q));
            c.forEach(function (c) {
              n = b(z(p, c.dlOptions || (c.options && c.options.dataLabels)));
              n.forEach(function (b, f) {
                var k =
                    b.enabled && (!c.isNull || c.dataLabelOnNull) && l(c, b),
                ...
                if (k) {
                  ...
                  u = E(x)
                    ? v(x, u, a)
                    : (b[c.formatPrefix + "Formatter"] || b.formatter).call(
                        u,
                        b
                      );
                  x = b.style;
                  var z = b.rotation;
                  a.styledMode ||
                    ((x.color = d(b.color, x.color, e.color, "#000000")),
                    "contrast" === x.color
                      ? ((c.contrastColor = m.getContrast(c.color || e.color)),
                        (x.color =
                          (!E(t) && b.inside) || 0 > t || g.stacking
                            ? c.contrastColor
                            : "#000000"))
                      : delete c.contrastColor,
                    g.cursor && (x.cursor = g.cursor));
                  var w = {
                    r: b.borderRadius || 0,
                    rotation: z,
                    padding: b.padding,
                ...
                !n ||
                  ...
                  c.dataLabels &&
                    (1 === c.dataLabels.length
                      ? delete c.dataLabels
                      : delete c.dataLabels[f]),
                  f || delete c.dataLabel,
                  p &&
                    ((c.connector = c.connector.destroy()),
                    c.connectors &&
                      (1 === c.connectors.length
                        ? delete c.connectors
                        : delete c.connectors[f])));
                k && E(u)
                  ? (n
                      ? (w.text = u)
                    ...
                    (n.options = b),
                    n.attr(w),
                    a.styledMode || n.css(x).shadow(b.shadow),
                    n.added || n.add(r),
                    b.textPath &&
                      !b.useHTML &&
                      (n.setTextPath(
      ...
      (function (e) {
        function l(e, d, b, f, l) {
          ...
          q &&
            ...
            x ||
              (h
                ? ((f.x += t ? 0 : f.width), (f.width = 0))
                : ((f.y += t ? f.height : 0), (f.height = 0))));
          b.align = E(b.align, !h || x ? "center" : t ? "right" : "left");
          b.verticalAlign = E(
            b.verticalAlign,
            h || x ? "middle" : t ? "top" : "bottom"
          );
          C.prototype.alignDataLabel.call(this, e, d, b, f, l);
          b.inside && e.contrastColor && d.css({ color: e.contrastColor });
        }
        var t = [];
        e.compose = function (e) {
          f.compose(C);
  ...
  K(
    ...
    [l["Core/Globals.js"], l["Core/Series/Series.js"], l["Core/Utilities.js"]],
    function (f, e, l) {
      var C = f.deg2rad,
        v = l.fireEvent,
        E = l.isNumber,
      ...
      (function (f) {
        f.getCenter = function () {
          ...
          f = [
            G(r[0], "50%"),
            G(r[1], "50%"),
            G(w && 0 > w ? void 0 : f.size, "100%"),
            G(z && 0 > z ? void 0 : f.innerSize || 0, "0%"),
          ];
          ...
          v(this, "afterGetCenter", { positions: f });
          return f;
        };
        f.getStartAndEndRadians = function (e, d) {
          e = E(e) ? e : 0;
          d = E(d) && d > e && 360 > d - e ? d : e + 360;
          return { start: C * (e + -90), end: C * (d + -90) };
        };
      })(y || (y = {}));
      ("");
      return y;
        ...
        d.prototype.setVisible = function (b, d) {
          ...
          b !== this.visible &&
            ((this.visible =
              ...
              b =
                "undefined" === typeof b ? !this.visible : b),
            ...
            this.legendItem && h.legend.colorizeItem(this, b),
            b || "hover" !== this.state || this.setState(""),
            l && (f.isDirty = !0),
            d && h.redraw());
        };
  ...
  K(
    ...
    [
      l["Series/CenteredUtilities.js"],
      l["Series/Column/ColumnSeries.js"],
      l["Core/Globals.js"],
      l["Core/Legend/LegendSymbol.js"],
      l["Series/Pie/PiePoint.js"],
      l["Core/Series/Series.js"],
      l["Core/Series/SeriesRegistry.js"],
      l["Core/Renderer/SVG/Symbols.js"],
      l["Core/Utilities.js"],
    ...
    function (f, e, l, C, v, E, G, B, y) {
      ...
      y = (function (b) {
        ...
        e.prototype.getX = function (b, e, f) {
          ...
          return (
            k[0] +
            (e ? -1 : 1) * Math.cos(b) * (a + f.labelDistance) +
            (0 < f.labelDistance
        ...
        e.prototype.redrawPoints = function () {
          ...
          !f ||
            b.shadowGroup ||
            d.styledMode ||
            (b.shadowGroup = e.g("shadow").attr({ zIndex: -1 }).add(b.group));
          b.points.forEach(function (k) {
            ...
            if (!k.isNull && g) {
              ...
              d.styledMode ||
                ...
                f &&
                  !m &&
                  (m = k.shadowGroup = e.g("shadow").add(b.shadowGroup)),
                m && m.attr(a),
                (c = b.pointAttribs(k, k.selected && "select")));
              k.delayedRendering
                ? (g.setRadialReference(b.center).attr(h).attr(a),
                  d.styledMode ||
                    g.attr(c).attr({ "stroke-linejoin": "round" }).shadow(f, m),
                  (k.delayedRendering = !1))
                : (g.setRadialReference(b.center),
                  d.styledMode || q(!0, l, c),
                  q(!0, l, h, a),
                  g.animate(l));
        ...
        e.prototype.translate = function (b) {
          ...
          for (t = 0; t < q; t++) {
            ...
            w.tooltipPos = [b[0] + 0.7 * B, b[1] + 0.7 * C];
            ...
            w.labelPosition = {
              ...
              connectorPosition: {
                ...
                touchingSliceAt: { x: b[0] + B, y: b[1] + C },
              },
            };
          }
        ...
        e.prototype.updateTotals = function () {
          ...
          for (f = 0; f < d; f++)
            (g = b[f]),
              (g.percentage = 0 < a && (g.visible || !e) ? (g.y / a) * 100 : 0),
              (g.total = a);
        };
      ...
      (function (e) {
        function l() {
          ...
          e.visible &&
            ...
            B.prototype.drawDataLabels.apply(e),
            f.forEach(function (a) {
              a.dataLabel &&
                (a.visible
                  ? (v[a.half].push(a),
                    ...
                    !h(g.style.width) &&
                      ...
                      a.dataLabel.getBBox().width > q &&
                      (a.dataLabel.css({ width: Math.round(0.7 * q) + "px" }),
              ...
              if (k) {
                ...
                if (0 < e.maxLabelDistance) {
                  ...
                  d.forEach(function (b) {
                    0 < b.labelDistance &&
                      b.dataLabel &&
                      ((b.top = Math.max(0, x - t - b.labelDistance)),
                      (b.bottom = Math.min(
                        x + t + b.labelDistance,
                        a.plotHeight
                      )),
                ...
                for (X = 0; X < k; X++) {
                  ...
                  m &&
                    ...
                    ("undefined" === typeof C.distributeBox.pos
                      ? (W = "hidden")
                      : ((T = C.distributeBox.size),
                        (V = z.radialDistributionY(C))));
                  ...
                  K._attr = { visibility: W, align: F.alignment };
                  Q = C.options.dataLabels || {};
                  K._pos = {
                    x:
                      N +
                      b(Q.x, g.x) +
                      ({ left: c, right: -c }[F.alignment] || 0),
                    y: V + b(Q.y, g.y) - 10,
                  };
                  F.final.x = N;
                  F.final.y = V;
                  b(g.crop, !0) &&
                    ...
                    N - P < c && 1 === f
                      ...
                      : N + P > l - c &&
                        0 === f &&
                        ((u = Math.round(N + P - l + c)),
                        (w[1] = Math.max(u, w[1]))),
                    0 > V - T / 2
                      ? (w[0] = Math.max(Math.round(-V + T / 2), w[0]))
                      : V + T / 2 > n &&
                        (w[2] = Math.max(Math.round(V + T / 2 - n), w[2])),
                    (K.sideOverflow = u));
                }
              }
            }),
            0 === y(w) || this.verifyDataLabelOverflow(w)) &&
            ...
            this.points.forEach(function (c) {
              ...
              if ((E = b(Q.connectorWidth, 1))) {
                ...
                if (
                  ...
                  J[f ? "attr" : "animate"]({ d: c.getConnectorPath() });
                  J.attr("visibility", W);
        ...
        function r(b) {
          ...
          if (!f) {
            if (null !== e[0]) var h = Math.max(d[2] - Math.max(b[1], b[3]), c);
              ...
              (h = Math.max(d[2] - b[1] - b[3], c)),
                (d[0] += (b[3] - b[1]) / 2);
            null !== e[1]
              ? (h = t(h, c, d[2] - Math.max(b[0], b[2])))
              : ((h = t(h, c, d[2] - b[0] - b[2])),
                (d[1] += (b[0] - b[2]) / 2));
            h < d[2]
              ? ((d[2] = h),
                (d[3] = Math.min(
                  a.thickness
                    ? Math.max(0, h - 2 * a.thickness)
                    : Math.max(0, p(a.innerSize || 0, h)),
                  h
                )),
                this.translate(d),
        ...
        e.compose = function (b) {
          ...
          -1 === v.indexOf(b) &&
            (v.push(b),
            (b = b.prototype),
            (b.dataLabelPositioners = x),
            (b.alignDataLabel = E),
            (b.drawDataLabels = l),
            (b.placeDataLabels = q),
            (b.verifyDataLabelOverflow = r));
        };
      })(q || (q = {}));
      return q;
    }
  ...
  K(
    ...
    [l["Core/Chart/Chart.js"], l["Core/Utilities.js"]],
    function (f, e) {
      function l(e, f) {
        var d = !1;
        if (e) {
            ...
            (e.alignAttr && e.placed
              ? (e[b ? "removeClass" : "addClass"](
                ...
                e[e.isOld ? "animate" : "attr"](e.alignAttr, null, function () {
                  f.styledMode || e.css({ pointerEvents: b ? "auto" : "none" });
                }),
      ...
      C(f, "render", function () {
        ...
        (this.yAxis || []).forEach(function (d) {
          d.stacking &&
            ...
            B(d.stacking.stacks, function (b) {
              B(b, function (b) {
      ...
      f.prototype.hideOverlappingLabels = function (e) {
        ...
        var t = function (d) {
          ...
          if (d && (!d.alignAttr || d.placed)) {
            var c = d.alignAttr || { x: d.attr("x"), y: d.attr("y") };
            var h = d.parentGroup;
            d.width ||
              ((e = d.getBBox()),
              (d.width = e.width),
              (d.height = e.height),
              (e = b.fontMetrics(null, d.element).h));
            var l = d.width - 2 * f;
            (g = { left: "0", center: "0.5", right: "1" }[d.alignValue])
              ? (a = +g * l)
              : G(d.x) &&
        ...
        for (q = 0; q < d; q++) {
          ...
          for (p = q + 1; p < d; ++p) {
            ...
            !w ||
              ...
              z.y >= w.y + w.height ||
              z.y + z.height <= w.y ||
              ((t.labelrank < r.labelrank ? t : r).newOpacity = 0);
          }
        }
    ...
    (function (d) {
      ...
      var f = (function () {
          ...
          function d(b, f, h, k) {
            ...
            G(b, function (b, c) {
              if (!k && -1 < e.collectionsWithUpdate.indexOf(c) && f[c])
                for (
                  b = y(b), h[c] = [], a = 0;
                  a < Math.max(b.length, f[c].length);
                  a++
                )
                  f[c][a] &&
                    (void 0 === b[a]
                      ? (h[c][a] = f[c][a])
                      : ((h[c][a] = {}), d(b[a], f[c][a], h[c][a], k + 1)));
              else
                v(b)
                  ? ((h[c] = C(b) ? [] : {}), d(b, f[c] || {}, h[c], k + 1))
                  : (h[c] = "undefined" === typeof f[c] ? null : f[c]);
            });
          }
          var e = this,
            f = {};
        ...
        b.prototype.setResponsive = function (b, d) {
          ...
          n = n.toString() || void 0;
          n !== (h && h.ruleIds) &&
            (h && this.update(h.undoOptions, b, !0),
            n
